...
void MotorPWM_Init(void) 
{
        ...
        ctrl = MotorPWM_CONTROL & ((uint8)(~MotorPWM_CTRL_CMPMODE2_MASK)) & ((uint8)(~MotorPWM_CTRL_CMPMODE1_MASK));
    ...
    /* Globally disable the Fixed Function Block chosen */
		...
		*******************************************************************************/
		void MotorPWM_SetCompareMode(uint8 comparemode) 
		{
		        ...
		        /*Clear existing mode */
		        MotorPWM_CONTROL &= ((uint8)(~(MotorPWM_CTRL_CMPMODE1_MASK | MotorPWM_CTRL_CMPMODE2_MASK))); 
...
void MotorPWM_WritePeriod(uint8 period) 
{
    ...
    *******************************************************************************/
    uint8 MotorPWM_ReadStatusRegister(void)   
    {
    	...
    	result = CY_GET_REG8(MotorPWM_STATUS_PTR);
    	return (result);
    }
