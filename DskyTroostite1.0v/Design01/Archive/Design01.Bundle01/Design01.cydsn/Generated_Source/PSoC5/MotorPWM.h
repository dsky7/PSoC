...
#define MotorPWM_INIT_COMPARE_VALUE1      127u
#define MotorPWM_INIT_COMPARE_VALUE2      63u
#define MotorPWM_INIT_INTERRUPTS_MODE     (uint8)(((uint8)(0u << MotorPWM_STATUS_TC_INT_EN_MASK_SHIFT)) | \
                                                  (uint8)((uint8)(0u << MotorPWM_STATUS_CMP2_INT_EN_MASK_SHIFT)) | \
                                                  (uint8)((uint8)(0u << MotorPWM_STATUS_CMP1_INT_EN_MASK_SHIFT )) | \
                                                  (uint8)((uint8)(0u << MotorPWM_STATUS_KILL_INT_EN_MASK_SHIFT )))
...
******************************** */
    ...
    ***********************************/
    ...
    #define MotorPWM_RT1_MASK              (uint8)((uint8)0x03u << MotorPWM_RT1_SHIFT)/* Sync TC and CMP bit masks */
    #define MotorPWM_SYNC                  (uint8)((uint8)0x03u << MotorPWM_RT1_SHIFT)
    #define MotorPWM_SYNCDSI_SHIFT         0x00u
    #define MotorPWM_SYNCDSI_MASK          (uint8)((uint8)0x0Fu << MotorPWM_SYNCDSI_SHIFT) /* Sync all DSI inputs */
    #define MotorPWM_SYNCDSI_EN            (uint8)((uint8)0x0Fu << MotorPWM_SYNCDSI_SHIFT) /* Sync all DSI inputs */
