...
using CyCustomizer.CyControlReg_v1_70;

namespace CyCustomizer.CyControlReg_v1_70
{
    [CyCompDevCustomizer()]
        ...
        ICyShapeCustomize_v1
    {
        ...
        public DialogResult EditParams(ICyInstEdit_v1 edit, ICyTerminalQuery_v1 termQuery, ICyExpressMgr_v1 mgr)
        {
            ...
            CyParamExprDelegate ParamCommitted = delegate(ICyParamEditor custEditor, CyCompDevParam comp)
            {
                ...
                if (comp.Name == CyControlReg_v1_70.ControlRegParameters.NUMOUTPUTS)
                {
                    int outputs;

                    if (!Int32.TryParse(
                                m_Component.GetCommittedParam(CyControlReg_v1_70.ControlRegParameters.NUMOUTPUTS).Value,
                                out outputs))
                    {
                    ...
                    m_Component.SetParamExpr(CyControlReg_v1_70.ControlRegParameters.BIT0MODE, Resources.DIRECTMODE);
                    m_Component.SetParamExpr(CyControlReg_v1_70.ControlRegParameters.BIT1MODE, Resources.DIRECTMODE);
                    m_Component.SetParamExpr(CyControlReg_v1_70.ControlRegParameters.BIT2MODE, Resources.DIRECTMODE);
                    m_Component.SetParamExpr(CyControlReg_v1_70.ControlRegParameters.BIT3MODE, Resources.DIRECTMODE);
                    m_Component.SetParamExpr(CyControlReg_v1_70.ControlRegParameters.BIT4MODE, Resources.DIRECTMODE);
                    m_Component.SetParamExpr(CyControlReg_v1_70.ControlRegParameters.BIT5MODE, Resources.DIRECTMODE);
                    m_Component.SetParamExpr(CyControlReg_v1_70.ControlRegParameters.BIT6MODE, Resources.DIRECTMODE);
                    m_Component.SetParamExpr(CyControlReg_v1_70.ControlRegParameters.BIT7MODE, Resources.DIRECTMODE);
                }
            };
        ...
        CyCustErr VerifyBitField(ICyDRCProviderArgs_v1 drcQuery)
        {
            ...
            outputs = Convert.ToInt16
                     (drcQuery.InstQueryV1.GetCommittedParam(CyControlReg_v1_70.ControlRegParameters.NUMOUTPUTS).Value);
        ...
        {
            CyCompDevParam busDisplay = instQuery.GetCommittedParam(CyControlReg_v1_70.ControlRegParameters.BUS);
            int outputs = Convert.ToInt16(
                                 instQuery.GetCommittedParam(CyControlReg_v1_70.ControlRegParameters.NUMOUTPUTS).Value);
