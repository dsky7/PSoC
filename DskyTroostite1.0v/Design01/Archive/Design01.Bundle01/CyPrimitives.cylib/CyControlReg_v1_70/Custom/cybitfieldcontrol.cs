...
namespace CyCustomizer.CyControlReg_v1_70
{
    public partial class CyBitfieldControl : UserControl
    {
        ...
        private void UpdateFormFromParams(ICyInstEdit_v1 inst)
        {
            ...
            bool.TryParse(m_Component.GetCommittedParam(CyControlReg_v1_70.ControlRegParameters.EXTERNALRESET).Value,
                            out extResetValue);
            ...
            bool.TryParse(m_Component.GetCommittedParam(CyControlReg_v1_70.ControlRegParameters.BUS).Value,
                            out busValue);
        ...
        private int GetNumOutputs()
        {
            ...
            if (!Int32.TryParse(m_Component.GetCommittedParam(CyControlReg_v1_70.ControlRegParameters.NUMOUTPUTS).Value,
                out outputs))
            {
        ...
        private void SaveOutputParameter()
        {
            ...
            {
                m_Component.SetParamExpr(CyControlReg_v1_70.ControlRegParameters.NUMOUTPUTS, nInputs.Value.ToString());
        ...
        private void chReset_CheckedChanged(object sender, EventArgs e)
        {
            ...
            {
                m_Component.SetParamExpr(CyControlReg_v1_70.ControlRegParameters.EXTERNALRESET, Resources.TRUE);
            }
            else
            {
                m_Component.SetParamExpr(CyControlReg_v1_70.ControlRegParameters.EXTERNALRESET, Resources.FALSE);
            }
            m_Component.CommitParamExprs();
        }
        ...
        private void chBus_CheckedChanged(object sender, EventArgs e)
        {
            ...
            {
                m_Component.SetParamExpr(CyControlReg_v1_70.ControlRegParameters.BUS, Resources.TRUE);
            }
            else
            {
                m_Component.SetParamExpr(CyControlReg_v1_70.ControlRegParameters.BUS, Resources.FALSE);
            }
            m_Component.CommitParamExprs();
        }
