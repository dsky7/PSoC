...
namespace Cypress.Semiconductor.CyDesigner.demux_v1_0
{
        ...
        ICyShapeCustomize_v1
    {
            ...
            out string codeSnippet)
        {
			...
			//================================================================
			// NB: Warp requires simple names in the sensitivity list, so we use  the base name;
			// cf. mux customizer code comments.
			//================================================================
            ...
            ICyTerminalEdit_v1 termEdit)
        {
            ...
            foreach (float offset in helper.GetTerminalOffsets())
            {
                ...
                if (index == 0)
                {
                    shapeEdit.ShapesMoveTo("lowest", new PointF(27.5f, offset - 2.3F));
                }
                shapeEdit.ShapesMoveTo("highest", new PointF(27.5f, offset - 3.5F));
