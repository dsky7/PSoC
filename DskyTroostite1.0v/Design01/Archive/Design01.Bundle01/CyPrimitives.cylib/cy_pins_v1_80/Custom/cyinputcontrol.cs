...
using Cypress.Comps.PinsAndPorts.Common_v1_80;

namespace Cypress.Comps.PinsAndPorts.cy_pins_v1_80
{
    public partial class CyInputControl : UserControl
    {
        ...
        public CyInputControl(ICyInstEdit_v1 instEdit)
        {
            ...
            m_inputBufferEnabledCheckBox.Enabled = !instEdit.DeviceQuery.IsPSoC4;
        ...
        public string InputBufferEnabled
        {
            ...
            set
            {
                ...
                m_inputBufferEnabledCheckBox.Enabled = !m_instEdit.DeviceQuery.IsPSoC4;
