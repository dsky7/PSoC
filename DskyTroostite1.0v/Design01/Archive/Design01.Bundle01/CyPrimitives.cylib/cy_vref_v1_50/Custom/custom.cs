...
namespace Cypress.Components.System.cy_vref_v1_50
{
    ...
    internal static class CyVRefInfo
    {
        ...
        const string ParamNameIgnoreSleep = "IgnoreSleep";
		...
		{
			return param.Name == ParamNameIgnoreSleep || param.Name == ParamNameAutoEnable;
		}
    }
}
