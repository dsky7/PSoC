...
`include "cypress.v"
`ifdef bVoltageFaultDetector_v2_30_V_ALREADY_INCLUDED
`else
`define bVoltageFaultDetector_v2_30_V_ALREADY_INCLUDED

module bVoltageFaultDetector_v2_30(pg_ov,pg_uv,en,clock,bus_clock,vs,pg_out,
    ...
    **************************************************************************/
    ...
    begin:Sts24   
        if(NumVoltages != 24)
        begin
            assign pg_status24[7:NumVoltages-16] = 0;
                       
            if(CompareType != UV_ONLY)
            begin
                assign ov_status24[7:NumVoltages-16] = 0;
            end
        end
        cy_psoc3_status #(.cy_force_order(1), .cy_md_select(8'h0))
        PGStsReg8(
...
`endif /* bVoltageFaultDetector_v2_30_V_ALREADY_INCLUDED */
