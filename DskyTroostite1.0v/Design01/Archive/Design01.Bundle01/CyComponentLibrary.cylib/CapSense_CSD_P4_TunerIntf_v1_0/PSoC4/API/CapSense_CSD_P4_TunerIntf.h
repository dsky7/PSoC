...
#if(`$INSTANCE_NAME`_SCB_MODE_EZBUF_I2C_CONST_CFG)
...
/***************************************
*   EZ Buffered I2C Macro Definitions
***************************************/

#define `$INSTANCE_NAME`_CHECK_STATUS_EC_BUSY   (0u != (`$INSTANCE_NAME`_STATUS_REG & `$INSTANCE_NAME`_STATUS_EC_BUSY))

/* Returns I2C EzAddress */
#define `$INSTANCE_NAME`_GET_I2C_STATUS_EZBUF_ADDRESS   (`$INSTANCE_NAME`_I2C_STATUS_REG >> \
                                                            `$INSTANCE_NAME`_I2C_STATUS_EZBUF_ADDR_POS)
