...
#define `$INSTANCE_NAME`_INIT_INTERRUPTS_MODE     (uint8)(((uint8)(`$IntOnTC`u << `$INSTANCE_NAME`_STATUS_TC_INT_EN_MASK_SHIFT)) | \
                                                  (uint8)((uint8)(`$IntOnCMP2`u << `$INSTANCE_NAME`_STATUS_CMP2_INT_EN_MASK_SHIFT)) | \
                                                  (uint8)((uint8)(`$IntOnCMP1`u << `$INSTANCE_NAME`_STATUS_CMP1_INT_EN_MASK_SHIFT )) | \
                                                  (uint8)((uint8)(`$IntOnKill`u << `$INSTANCE_NAME`_STATUS_KILL_INT_EN_MASK_SHIFT )))
