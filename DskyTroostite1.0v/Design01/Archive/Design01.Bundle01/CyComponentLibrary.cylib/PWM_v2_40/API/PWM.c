...
void `$INSTANCE_NAME`_Init(void) `=ReentrantKeil($INSTANCE_NAME . "_Init")`
{
        ...
        #if(CY_PSOC5A)
                ctrl = `$INSTANCE_NAME`_CONTROL2 & ((uint8)(~`$INSTANCE_NAME`_CTRL_CMPMODE1_MASK));
        ...
        ctrl = `$INSTANCE_NAME`_CONTROL & ((uint8)(~`$INSTANCE_NAME`_CTRL_CMPMODE2_MASK)) & ((uint8)(~`$INSTANCE_NAME`_CTRL_CMPMODE1_MASK));
...
void `$INSTANCE_NAME`_Stop(void) `=ReentrantKeil($INSTANCE_NAME . "_Stop")`
{
    ...
    /* Globally disable the Fixed Function Block chosen */
		...
		*******************************************************************************/
		void `$INSTANCE_NAME`_SetCompareMode(uint8 comparemode) `=ReentrantKeil($INSTANCE_NAME . "_SetCompareMode")`
		{
		        ...
		        #if(CY_PSOC5A)
		            `$INSTANCE_NAME`_CONTROL2 &= ((uint8)(~`$INSTANCE_NAME`_CTRL_CMPMODE1_MASK)); /*Clear Existing Data */
		        ...
		        /*Clear existing mode */
		        `$INSTANCE_NAME`_CONTROL &= ((uint8)(~(`$INSTANCE_NAME`_CTRL_CMPMODE1_MASK | `$INSTANCE_NAME`_CTRL_CMPMODE2_MASK))); 
    ...
    *******************************************************************************/
    `$RegSizeReplacementString` `$INSTANCE_NAME`_ReadCounter(void) `=ReentrantKeil($INSTANCE_NAME . "_ReadCounter")`
    {
        ...
        (void)`$INSTANCE_NAME`_COUNTERCAP_LSB;
...
void `$INSTANCE_NAME`_WritePeriod(`$RegSizeReplacementString` period) `=ReentrantKeil($INSTANCE_NAME . "_WritePeriod")`
{
    ...
    *******************************************************************************/
    uint8 `$INSTANCE_NAME`_ReadStatusRegister(void) `=ReentrantKeil($INSTANCE_NAME . "_ReadStatusRegister")`  
    {
    	...
    	result = CY_GET_REG8(`$INSTANCE_NAME`_STATUS_PTR);
    	return (result);
    }
