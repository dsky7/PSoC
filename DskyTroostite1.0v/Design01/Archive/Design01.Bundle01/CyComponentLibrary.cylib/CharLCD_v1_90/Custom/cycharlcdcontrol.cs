...
namespace CharLCD_v1_90
{
    public partial class CyCharLCDControl : UserControl
    {
        ...
        {
            CharLCD_v1_90.CyCustomCharacter current = (CharLCD_v1_90.CyCustomCharacter)sender;
            CharLCD_v1_90.CyBox clickedBox = current.GetBoxByLocation(e.X, e.Y);
            if (clickedBox != null)
            {
        ...
        private void custArray_MouseMove(object sender, MouseEventArgs e)
        {
            ...
            {
                CharLCD_v1_90.CyCustomCharacter current = (CharLCD_v1_90.CyCustomCharacter)sender;
                CharLCD_v1_90.CyBox currentBox = current.GetBoxByLocation(e.X, e.Y);
                if (currentBox != null)
                {
        ...
        {
            CharLCD_v1_90.CyCustomCharacter selectedCharacter = (CharLCD_v1_90.CyCustomCharacter)sender;
        ...
        public void CYStringToCharacter(CyCustomCharacter customCharacter, string cyCharacterString)
        {
            ...
            CharLCD_v1_90.CyBox[,] boxes = customCharacter.GetBoxArray();
        ...
        public string CharacterToCYString(CyCustomCharacter customCharacter)
        {
            ...
            CharLCD_v1_90.CyBox[,] pixelArray = customCharacter.GetBoxArray();
        ...
        private void HighlightNext()
        {
            ...
            UpdateHighlighted((CharLCD_v1_90.CyCustomCharacter)m_userDefinedCharacters[next]);
        }
        ...
        private void HighlightPrevious()
        {
            ...
            // Cast from Object to CustomCharacter
            UpdateHighlighted((CharLCD_v1_90.CyCustomCharacter)m_userDefinedCharacters[previous]);
        }
        ...
        private void HighlightAbove()
        {
            ...
            // Cast from Object to CustomCharacter
            UpdateHighlighted((CharLCD_v1_90.CyCustomCharacter)m_userDefinedCharacters[above]);
        }
        private void HighlightBelow()
        {
            ...
            // Cast from Object to CustomCharacter
            UpdateHighlighted((CharLCD_v1_90.CyCustomCharacter)m_userDefinedCharacters[below]);
        }
        ...
        private void CustomCharactersOff()
        {
            ...
            for (int i = 0; i < this.panel1.Controls.Count; i++)
            {
                CharLCD_v1_90.CyCustomCharacter character = (CharLCD_v1_90.CyCustomCharacter)this.panel1.Controls[i];
