...
namespace ADC_SAR_SEQ_v1_10
{
    ...
    public static class CyParamRanges
    {
        ...
        public const double MAX_CLOCK_FREQ_KHZ = MAX_CLOCK_FREQ_MHZ * 1000;
    ...
    public class CyParameters
    {
        ...
        const UInt32 SAMPLE_PER_CHARGE_PSOC5LP = 6;
        ...
        private UInt32 SamplePerCharge
        {
            get
            {
                return SAMPLE_PER_CHARGE_PSOC5LP;
            }
        }
        ...
        public UInt32 ClocksPerSample
        {
            get
            {
                return (UInt32)Resolution + SamplePerCharge;
            }
        }
        ...
        {
            List<CyClockData> clkdata = termQuery.GetClockData("or_internal", "term1", 0);
