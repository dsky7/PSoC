...
namespace ADC_SAR_SEQ_v1_10
{
    public partial class CyConfigTab : UserControl, ICyParamEditingControl
    {
        ...
        public void UpdateUI()
        {
            ...
            m_numClockFreq.Text = (m_params.ChannelSampleRate * m_params.ClocksPerSample / 1000.0).ToString();
            ...
            if (numControl != null)
            {
                ...
                else if (numControl == m_numClockFreq)
                {
                    ...
                    if (parsed == true && value >= CyParamRanges.MIN_CLOCK_FREQ_KHZ &&
                        value <= CyParamRanges.MAX_CLOCK_FREQ_KHZ)
                    {
                    ...
                    else
                    {
                        m_errorProvider.SetError(m_numClockFreq,
                            ...
                            CyParamRanges.MIN_CLOCK_FREQ_MHZ, CyParamRanges.MAX_CLOCK_FREQ_MHZ));
                    }
                }
