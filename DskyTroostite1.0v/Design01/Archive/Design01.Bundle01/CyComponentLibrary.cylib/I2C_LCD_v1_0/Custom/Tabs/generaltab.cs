...
namespace I2C_LCD_v1_0
{
    public partial class CyGeneralTab : CyTabWrapper
    {
        ...
        {
            I2C_LCD_v1_0.CyCustomCharacter current = (I2C_LCD_v1_0.CyCustomCharacter)sender;
            I2C_LCD_v1_0.CyBox clickedBox = current.GetBoxByLocation(e.X, e.Y);
            if (clickedBox != null)
            {
        ...
        private void custArray_MouseMove(object sender, MouseEventArgs e)
        {
            ...
            {
                I2C_LCD_v1_0.CyCustomCharacter current = (I2C_LCD_v1_0.CyCustomCharacter)sender;
                I2C_LCD_v1_0.CyBox currentBox = current.GetBoxByLocation(e.X, e.Y);
                if (currentBox != null)
                {
        ...
        {
            I2C_LCD_v1_0.CyCustomCharacter selectedCharacter = (I2C_LCD_v1_0.CyCustomCharacter)sender;
        ...
        public void CyStringToCharacter(CyCustomCharacter customCharacter, string cyCharacterString)
        {
            ...
            I2C_LCD_v1_0.CyBox[,] boxes = customCharacter.GetBoxArray();
        ...
        public string CharacterToCYString(CyCustomCharacter customCharacter)
        {
            ...
            I2C_LCD_v1_0.CyBox[,] pixelArray = customCharacter.GetBoxArray();
        ...
        private void HighlightNext()
        {
            ...
            UpdateHighlighted((I2C_LCD_v1_0.CyCustomCharacter)m_userDefinedCharacters[next]);
        }
        ...
        private void HighlightPrevious()
        {
            ...
            // Cast from Object to CustomCharacter
            UpdateHighlighted((I2C_LCD_v1_0.CyCustomCharacter)m_userDefinedCharacters[previous]);
        }
        ...
        private void HighlightAbove()
        {
            ...
            // Cast from Object to CustomCharacter
            UpdateHighlighted((I2C_LCD_v1_0.CyCustomCharacter)m_userDefinedCharacters[above]);
        }
        private void HighlightBelow()
        {
            ...
            // Cast from Object to CustomCharacter
            UpdateHighlighted((I2C_LCD_v1_0.CyCustomCharacter)m_userDefinedCharacters[below]);
        }
        ...
        private void CustomCharactersOff()
        {
            ...
            for (int i = 0; i < this.panel1.Controls.Count; i++)
            {
                I2C_LCD_v1_0.CyCustomCharacter character = (I2C_LCD_v1_0.CyCustomCharacter)this.panel1.Controls[i];
