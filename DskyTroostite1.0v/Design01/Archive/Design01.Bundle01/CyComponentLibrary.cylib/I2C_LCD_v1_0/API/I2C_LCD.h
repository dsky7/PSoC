...
/* This condition check is needed to check if I2C Master implemented on SCB
* block. There is a mismatch in function names between I2C Master that is
...
/* This value should be generated by the API customizer */
...
#define `$INSTANCE_NAME`_CUSTOM_7                       (0x07u)
    ...
    /* This is the mask for character set "S" that is used in NXP
