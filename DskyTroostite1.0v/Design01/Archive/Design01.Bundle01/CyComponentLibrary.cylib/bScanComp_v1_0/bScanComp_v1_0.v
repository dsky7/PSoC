...
`include "cypress.v"
`ifdef bScanComp_v1_0_V_ALREADY_INCLUDED
`else
`define bScanComp_v1_0_V_ALREADY_INCLUDED

module bScanComp_v1_0
(
    input    wire    		clk,
    input    wire    		comp_o,
...
`endif /* bScanComp_v1_0_V_ALREADY_INCLUDED */
