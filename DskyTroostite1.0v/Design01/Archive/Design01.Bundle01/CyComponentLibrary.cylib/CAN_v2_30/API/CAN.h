...
#define `$INSTANCE_NAME`_TX_WPN_SET             (((uint32) ((uint32) 0x00000001u << `$INSTANCE_NAME`_TX_WPNL_SHIFT)) | \
                                                ((uint32) ((uint32) 0x00000001u << (`$INSTANCE_NAME`_TWO_BYTE_OFFSET + \
...
#define `$INSTANCE_NAME`_RX_BUF_DISABLE(i)        (`$INSTANCE_NAME`_RX[i].rxcmd.byte[0u] &= \
                                                   (uint8) (~`$INSTANCE_NAME`_RX_BUF_ENABLE_MASK))
...
#define `$INSTANCE_NAME`_CLEAR_RX_RTRREPLY(i)     (`$INSTANCE_NAME`_RX[i].rxcmd.byte[0u] &= \
                                                   (uint8) (~`$INSTANCE_NAME`_RX_RTRREPLY_MASK))
...
#define `$INSTANCE_NAME`_RX_INT_DISABLE(i)        (`$INSTANCE_NAME`_RX[i].rxcmd.byte[0u] &= \
                                                   (uint8) (~`$INSTANCE_NAME`_RX_INT_ENABLE_MASK))
...
#define `$INSTANCE_NAME`_CLEAR_RX_LINKING(i)      (`$INSTANCE_NAME`_RX[i].rxcmd.byte[0u] &= \
                                                   (uint8) (~`$INSTANCE_NAME`_RX_LINKING_MASK))
...
#define `$INSTANCE_NAME`_CLEAR_RX_WNPL(i)       (`$INSTANCE_NAME`_RX[i].rxcmd.byte[0u] &= \
                                                 (uint8) (~`$INSTANCE_NAME`_RX_WPNL_MASK))
...
#define `$INSTANCE_NAME`_CLEAR_RX_WNPH(i)       (`$INSTANCE_NAME`_RX[i].rxcmd.byte[2u] &= \
                                                 (uint8) (~`$INSTANCE_NAME`_RX_WPNH_MASK))
...
#define `$INSTANCE_NAME`_TX_INT_ENABLE_MASK    ((uint32) ((uint32) 0x00000001u << `$INSTANCE_NAME`_TX_INT_ENABLE_SHIFT))
#define `$INSTANCE_NAME`_TX_INT_ENABLE(i)      (`$INSTANCE_NAME`_TX[i].txcmd.byte[0u] |= \
                                                (uint8) `$INSTANCE_NAME`_TX_INT_ENABLE_MASK)
...
#define `$INSTANCE_NAME`_CLEAR_TX_WNPL(i)      (`$INSTANCE_NAME`_TX[i].txcmd.byte[0u] &= \
                                                (uint8) (~`$INSTANCE_NAME`_TX_WPNL_MASK))

/* bits 19-16 within TX_CMD[i] */
#define `$INSTANCE_NAME`_TX_DLC_VALUE_SHIFT       (0u)
#define `$INSTANCE_NAME`_TX_DLC_UPPER_VALUE_SHIFT (19u)
#define `$INSTANCE_NAME`_TX_DLC_UPPER_VALUE       ((uint32) ((uint32) 0x00000001u << \
                                                   `$INSTANCE_NAME`_TX_DLC_UPPER_VALUE_SHIFT))
...
#define `$INSTANCE_NAME`_SET_TX_IDE(i)            (`$INSTANCE_NAME`_TX[i].txcmd.byte[2u] |= \
                                                   (uint8) (`$INSTANCE_NAME`_TX_IDE_MASK >> \
                                                   `$INSTANCE_NAME`_TWO_BYTE_OFFSET))
#define `$INSTANCE_NAME`_CLEAR_TX_IDE(i)          (`$INSTANCE_NAME`_TX[i].txcmd.byte[2u] &= \
                                                   (uint8) (((uint32) (~`$INSTANCE_NAME`_TX_IDE_MASK)) >> \
                                                   `$INSTANCE_NAME`_TWO_BYTE_OFFSET))
...
#define `$INSTANCE_NAME`_SET_TX_RTR(i)            (`$INSTANCE_NAME`_TX[i].txcmd.byte[2u] |= \
                                                   (uint8) (`$INSTANCE_NAME`_TX_RTR_MASK >> \
                                                   `$INSTANCE_NAME`_TWO_BYTE_OFFSET))
#define `$INSTANCE_NAME`_CLEAR_TX_RTR(i)          (`$INSTANCE_NAME`_TX[i].txcmd.byte[2u] &= \
                                                   (uint8) (((uint32) (~`$INSTANCE_NAME`_TX_RTR_MASK)) >> \
                                                   `$INSTANCE_NAME`_TWO_BYTE_OFFSET))
...
#define `$INSTANCE_NAME`_CLEAR_TX_WNPH(i)        (`$INSTANCE_NAME`_TX[i].txcmd.byte[2u] &= \
                                                  (uint8) (~`$INSTANCE_NAME`_TX_WPN_MASK))
...
#define `$INSTANCE_NAME`_SET_TX_ID_STANDARD_MSG(i, id) (CY_SET_REG32((reg32 *) &`$INSTANCE_NAME`_TX[i].txid, \
                                        ((uint32) ((uint32) (id) << `$INSTANCE_NAME`_SET_TX_ID_STANDARD_MSG_SHIFT))))
#define `$INSTANCE_NAME`_SET_TX_ID_EXTENDED_MSG(i, id) (CY_SET_REG32((reg32 *) &`$INSTANCE_NAME`_TX[i].txid, \
...
#define `$INSTANCE_NAME`_ARBITRATION_LOST_INT_DISABLE  (`$INSTANCE_NAME`_INT_EN_REG.byte[0u] &= \
                                                       (uint8) (~`$INSTANCE_NAME`_ARBITRATION_LOST_MASK))
...
#define `$INSTANCE_NAME`_OVERLOAD_ERROR_INT_DISABLE   (`$INSTANCE_NAME`_INT_EN_REG.byte[0u] &= \
                                                      (uint8) (~`$INSTANCE_NAME`_OVERLOAD_ERROR_MASK))
...
#define `$INSTANCE_NAME`_BIT_ERROR_LOST_INT_DISABLE    (`$INSTANCE_NAME`_INT_EN_REG.byte[0u] &= \
                                                       (uint8) (~`$INSTANCE_NAME`_BIT_ERROR_MASK))
...
#define `$INSTANCE_NAME`_STUFF_ERROR_INT_DISABLE       (`$INSTANCE_NAME`_INT_EN_REG.byte[0u] &= \
                                                       (uint8) (~`$INSTANCE_NAME`_STUFF_ERROR_MASK))
...
#define `$INSTANCE_NAME`_ACK_ERROR_INT_DISABLE         (`$INSTANCE_NAME`_INT_EN_REG.byte[0u] &= \
                                                       (uint8) (~`$INSTANCE_NAME`_ACK_ERROR_MASK))
...
#define `$INSTANCE_NAME`_FORM_ERROR_INT_DISABLE        (`$INSTANCE_NAME`_INT_EN_REG.byte[0u] &= \
                                                        (uint8) (~`$INSTANCE_NAME`_FORM_ERROR_MASK))
...
#define `$INSTANCE_NAME`_CRC_ERROR_INT_DISABLE         (`$INSTANCE_NAME`_INT_EN_REG.byte[1u] &= \
                                                        (uint8) (~`$INSTANCE_NAME`_CRC_ERROR_MASK))
...
#define `$INSTANCE_NAME`_BUS_OFF_INT_DISABLE           (`$INSTANCE_NAME`_INT_EN_REG.byte[1u] &= \
                                                        (uint8) (~`$INSTANCE_NAME`_BUS_OFF_MASK))
...
#define `$INSTANCE_NAME`_RX_MSG_LOST_INT_DISABLE       (`$INSTANCE_NAME`_INT_EN_REG.byte[1u] &= \
                                                        (uint8) (~`$INSTANCE_NAME`_RX_MSG_LOST_MASK))
...
#define `$INSTANCE_NAME`_TX_MSG_INT_DISABLE            (`$INSTANCE_NAME`_INT_EN_REG.byte[1u] &= \
                                                        (uint8) (~`$INSTANCE_NAME`_TX_MESSAGE_MASK))
...
#define `$INSTANCE_NAME`_RX_MSG_INT_DISABLE            (`$INSTANCE_NAME`_INT_EN_REG.byte[1u] &= \
                                                        (uint8) (~`$INSTANCE_NAME`_RX_MESSAGE_MASK))
...
#define `$INSTANCE_NAME`_ARBITRATION_LOST_ENABLE ((uint16) ((uint16) 0x01u << \
                                                            `$INSTANCE_NAME`_ARBITRATION_LOST_ENABLE_SHIFT))
#define `$INSTANCE_NAME`_OVERLOAD_ERROR_ENABLE   ((uint16) ((uint16) 0x01u << \
                                                            `$INSTANCE_NAME`_OVERLOAD_ERROR_ENABLE_SHIFT))
