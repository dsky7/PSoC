...
`include "cypress.v"
`ifdef B_SPI_Slave_v2_40_V_ALREADY_INCLUDED
`else
`define B_SPI_Slave_v2_40_V_ALREADY_INCLUDED

module B_SPI_Slave_v2_40(
    ...
    **************************************************************************/
    ...
    begin:es2
        ...
        B_SPI_Slave_ES2_v2_40 #(.ModePOL(ModePOL), .ModeCPHA(ModeCPHA),.ShiftDir(ShiftDir),
        ...
        B_SPI_Slave_ES3_v2_40 #(.ModePOL(ModePOL), .ModeCPHA(ModeCPHA),.ShiftDir(ShiftDir),
                          .NumberOfDataBits(NumberOfDataBits),.BidirectMode(BidirectMode))
        SPISlave(
            .reset(reset),
            .clock(clock),
    ...
    `ifdef B_SPI_Slave_ES3_v2_40_V_ALREADY_INCLUDED
    `else
    `define B_SPI_Slave_ES3_v2_40_V_ALREADY_INCLUDED

    module B_SPI_Slave_ES3_v2_40(
        input  wire reset,     /* System Reset             */
        input  wire clock,     /* System Clk - 2x Bit rate */
        input  wire mosi,      /* SPI MOSI input           */
        input  wire sclk,      /* SPI SCLK input           */
    ...
    `endif /* B_SPI_Slave_ES3_v2_40__V_ALREADY_INCLUDED */

    `ifdef B_SPI_Slave_ES2_v2_40__V_ALREADY_INCLUDED
    `else
    `define B_SPI_Slave_ES2_v2_40__V_ALREADY_INCLUDED

    module B_SPI_Slave_ES2_v2_40(
        input  wire reset,     /*System Reset */
        input  wire clock,     /* System Clk - 2x Bit rate */
        input  wire mosi,      /* SPI MOSI input */
        input  wire sclk,      /* SPI SCLK input */
...
`endif /* B_SPI_Slave_ES2_v2_40_V_ALREADY_INCLUDED */
`endif /* B_SPI_Slave_v2_40_V_ALREADY_INCLUDED */
