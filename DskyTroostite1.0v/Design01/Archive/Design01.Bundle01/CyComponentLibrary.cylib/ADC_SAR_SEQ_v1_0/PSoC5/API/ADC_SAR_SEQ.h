...
extern volatile int16 `$INSTANCE_NAME`_SAR_offset;
extern volatile int16 `$INSTANCE_NAME`_SAR_countsPerVolt;
extern volatile int16 `$INSTANCE_NAME`_SAR_shift;
...
#define `$INSTANCE_NAME`_FINAL_BYTES_PER_BURST    ((uint8)`$INSTANCE_NAME`_NUMBER_OF_CHANNELS << 1u)
