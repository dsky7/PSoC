...
namespace Counter_v2_30
{
    public partial class CyCounterControlAdv : UserControl
    {
        ...
        public void UpdateFormFromParams(ICyInstEdit_v1 inst)
        {
            ...
            // Store old values
            m_reloadOnCapCheckedUDB = (prms.m_reloadOnCapture.Value == CyCounterParameters.TRUE) ? true : false;
            m_reloadOnCompCheckedUDB = (prms.m_reloadOnCompare.Value == CyCounterParameters.TRUE) ? true : false;
            m_reloadOnResetCheckedUDB = (prms.m_reloadOnReset.Value == CyCounterParameters.TRUE) ? true : false;
            m_reloadOnTCCheckedUDB = (prms.m_reloadOnOverUnder.Value == CyCounterParameters.TRUE) ? true : false;
            ...
            prms = new CyCounterParameters(inst);

            m_ff = (prms.m_fixedFunction.Value == Counter_v2_30.CyCounterParameters.TRUE) ? true : false;

            //Set Interrupt on Check Boxes
            m_chbxIntSrcCapture.Checked = (prms.m_interruptOnCapture.Value == CyCounterParameters.TRUE) ? true : false;
            m_chbxIntSrcCompare.Checked = (prms.m_interruptOnCompare.Value == CyCounterParameters.TRUE) ? true : false;

            if (m_ff)
                m_chbxIntSrcTC.Checked = (prms.m_interruptOnTC.Value == CyCounterParameters.TRUE) ? true : false;
            else
                m_chbxIntSrcTC.Checked = (prms.m_interruptOnOverUnderFlow.Value == CyCounterParameters.TRUE) ?
                    true : false;
        ...
        private void SetFixedFunction()
        {
            ...
            {
                CyCounterParameters.SetAParameter(CyCounterParameters.CAPTUREMODE, prm, m_component);
            }
            ...
            {
                CyCounterParameters.SetAParameter(CyCounterParameters.ENABLEMODE, prm2, m_component);
            }
            ...
            {
                CyCounterParameters.SetAParameter(CyCounterParameters.INTERRUPT_ON_CAPTURE, CyCounterParameters.FALSE,
                                                m_component);
            }
            ...
            {
                CyCounterParameters.SetAParameter(CyCounterParameters.INTERRUPT_ON_COMPARE, CyCounterParameters.FALSE,
                                                m_component);
            }
        }
        ...
        void UpdateCheckBoxParameter(string paramName, bool isChecked, bool visible)
        {
            if (isChecked && visible)
                CyCounterParameters.SetAParameter(paramName, CyCounterParameters.TRUE, m_component);
            else
                CyCounterParameters.SetAParameter(paramName, CyCounterParameters.FALSE, m_component);
        }
        ...
        {
            CheckBox cb = (CheckBox)sender;
            CyCounterParameters.SetAParameter(CyCounterParameters.RELOAD_ON_RESET, cb.Checked.ToString(), m_component);
        }

        private void m_chbxReloadOnTC_Changed(object sender, EventArgs e)
        {
            CheckBox cb = (CheckBox)sender;
            CyCounterParameters.SetAParameter(CyCounterParameters.RELOAD_ON_OVERUNDER, cb.Checked.ToString(),
                m_component);
        }
        ...
        private void m_cbEnableMode_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            CyCounterParameters.SetAParameter(CyCounterParameters.ENABLEMODE, prm, m_component);
        }
        ...
        private void m_cbRunMode_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            CyCounterParameters.SetAParameter(CyCounterParameters.RUNMODE, prm, m_component);
        }
    }
}
