...
namespace Counter_v2_30
{
    public partial class CyCounterControl : UserControl
    {
        ...
        {
            UnhookUpdateEvents();
            CyCounterParameters prms = new CyCounterParameters(inst);
            ...
            m_numPeriod.Value = Convert.ToInt64(prms.m_period.Value);
            switch (prms.m_fixedFunction.Value)
            {
                case CyCounterParameters.TRUE: m_rbFixedFunction.Checked = true; break;
                case CyCounterParameters.FALSE: m_rbUDB.Checked = true; break;
                default: Debug.Fail(CyCounterParameters.UNHANDLED_CASE); break;
            }

            //Set Compare Value numeric up down
            m_numCompare1.Value = Convert.ToInt64(prms.m_compareValue.Value);
        ...
        private void SetFixedFunction()
        {
            ...
            {
                CyCounterParameters.SetAParameter(CyCounterParameters.CLOCKMODE,
                                                prm, m_component);
            }
            ...
            {
                CyCounterParameters.SetAParameter(Counter_v2_30.CyCounterParameters.INTERRUPT_ON_CAPTURE,
                                                Counter_v2_30.CyCounterParameters.FALSE, m_component);
            }
        }
        ...
        private void m_numPeriod_ValueChanged(object sender, EventArgs e)
        {
            ...
            if (!ce.Cancel)
            {
                CyCounterParameters.SetAParameter(CyCounterParameters.PERIOD, m_numPeriod.Value.ToString()
                                                + "u", m_component);
                if (m_cbClockMode.SelectedIndex == 2 || m_cbClockMode.SelectedIndex == 3)
                    ...
                    m_numCompare1.Maximum = Counter_v2_30.CyCounterParameters.CONST_2_8;
                else if (m_rbResolution16.Checked)
                    m_numCompare1.Maximum = Counter_v2_30.CyCounterParameters.CONST_2_16;
                else if (m_rbResolution24.Checked)
                    m_numCompare1.Maximum = Counter_v2_30.CyCounterParameters.CONST_2_24;
                else
                    m_numCompare1.Maximum = Counter_v2_30.CyCounterParameters.CONST_2_32;
            }
        }
        ...
        private void m_rbResolution8_Click(object sender, MouseEventArgs e)
        {
            if (!m_rbResolution8.Checked)
            {
                ...
                CyCounterParameters.SetAParameter(Counter_v2_30.CyCounterParameters.RESOLUTION,
                                                Counter_v2_30.CyCounterParameters.EIGHT_BIT, m_component);
            }
        ...
        private void m_rbResolution16_Click(object sender, EventArgs e)
        {
            if (!m_rbResolution16.Checked)
            {
                ...
                m_rbResolution32.Checked = false;
                CyCounterParameters.SetAParameter(Counter_v2_30.CyCounterParameters.RESOLUTION,
                                                Counter_v2_30.CyCounterParameters.SIXTEEN_BIT, m_component);
            }
            m_numPeriod_Validating(sender, new CancelEventArgs());
            m_numCompare1_Validating(sender, new CancelEventArgs());
        }
        ...
        private void m_rbResolution24_Click(object sender, EventArgs e)
        {
            if (!m_rbResolution24.Checked)
            {
                ...
                m_rbResolution32.Checked = false;
                CyCounterParameters.SetAParameter(Counter_v2_30.CyCounterParameters.RESOLUTION,
                                                Counter_v2_30.CyCounterParameters.TWENTYFOUR_BIT, m_component);
            }
            m_numPeriod_Validating(sender, new CancelEventArgs());
            m_numCompare1_Validating(sender, new CancelEventArgs());
        }
        ...
        private void m_rbResolution32_Click(object sender, EventArgs e)
        {
            if (!m_rbResolution32.Checked)
            {
                ...
                CyCounterParameters.SetAParameter(Counter_v2_30.CyCounterParameters.RESOLUTION,
                                                Counter_v2_30.CyCounterParameters.THIRTYTWO_BIT, m_component);
            }
            m_numPeriod_Validating(sender, new CancelEventArgs());
            m_numCompare1_Validating(sender, new CancelEventArgs());
        ...
        private void m_rbFixedFunction_Click(object sender, EventArgs e)
        {
            if (!m_rbFixedFunction.Checked)
            {
                ...
                SetFixedFunction();
                CyCounterParameters.SetAParameter(Counter_v2_30.CyCounterParameters.FIXEDFUNCTION,
                                                Counter_v2_30.CyCounterParameters.TRUE, m_component);
                UpdateAdvancedForm();
            }
        }
        ...
        {
            if (m_rbResolution8.Checked)
                m_numPeriod.Value = m_cbClockMode.SelectedIndex > 1 ? Counter_v2_30.CyCounterParameters.CONST_2_8 :
                    Counter_v2_30.CyCounterParameters.CONST_2_8 - 1;
            else if (m_rbResolution16.Checked)
                m_numPeriod.Value = m_cbClockMode.SelectedIndex > 1 ? Counter_v2_30.CyCounterParameters.CONST_2_16 :
                    Counter_v2_30.CyCounterParameters.CONST_2_16 - 1;
            else if (m_rbResolution24.Checked)
                m_numPeriod.Value = m_cbClockMode.SelectedIndex > 1 ? Counter_v2_30.CyCounterParameters.CONST_2_24 :
                    Counter_v2_30.CyCounterParameters.CONST_2_24 - 1;
            else
                m_numPeriod.Value = m_cbClockMode.SelectedIndex > 1 ? Counter_v2_30.CyCounterParameters.CONST_2_32 :
                    Counter_v2_30.CyCounterParameters.CONST_2_32 - 1;
        }
        ...
        private void m_bMaxCompareValue_Click(object sender, EventArgs e)
        {
            ...
            {
                m_numCompare1.Maximum = Counter_v2_30.CyCounterParameters.CONST_2_8;
                m_numCompare1.Value = Counter_v2_30.CyCounterParameters.CONST_2_8;
            }
            else if (m_rbResolution16.Checked)
            {
                m_numCompare1.Maximum = Counter_v2_30.CyCounterParameters.CONST_2_16;
                m_numCompare1.Value = Counter_v2_30.CyCounterParameters.CONST_2_16;
            }
            else if (m_rbResolution24.Checked)
            {
                m_numCompare1.Maximum = Counter_v2_30.CyCounterParameters.CONST_2_24;
                m_numCompare1.Value = Counter_v2_30.CyCounterParameters.CONST_2_24;
            }
            else
            {
                m_numCompare1.Maximum = Counter_v2_30.CyCounterParameters.CONST_2_32;
                m_numCompare1.Value = Counter_v2_30.CyCounterParameters.CONST_2_32;
            }
        }
        ...
        private void m_numCompare1_ValueChanged(object sender, EventArgs e)
        {
            ...
            if (!ce.Cancel)
            {
                CyCounterParameters.SetAParameter(CyCounterParameters.COMPAREVALUE,
                                               m_numCompare1.Value.ToString() + CyCounterParameters.UNIT, m_component);
            }
        }
        ...
        private void m_cbClockMode_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            CyCounterParameters.SetAParameter(CyCounterParameters.CLOCKMODE, prm, m_component);
        ...
        private void m_cbCompareMode_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            CyCounterParameters.SetAParameter(CyCounterParameters.COMPAREMODE, prm, m_component);
        }
        ...
        private void CyCounterControl_Load(object sender, EventArgs e)
        {
            if (m_component.DeviceQuery.IsPSoC4)
            {
                ...
                CyCounterParameters.SetAParameter(CyCounterParameters.FIXEDFUNCTION, "false", m_component);
            }
        }
