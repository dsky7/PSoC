...
extern void `$INSTANCE_NAME`_PreScan(uint8 sensor) CYREENTRANT;
#if (`$INSTANCE_NAME`_DESIGN_TYPE == `$INSTANCE_NAME`_ONE_CHANNEL_DESIGN)
    extern void `$INSTANCE_NAME`_PostScan(uint8 sensor) CYREENTRANT;
#else
    extern void `$INSTANCE_NAME`_PostScanCh0(uint8 sensor) CYREENTRANT;
    extern void `$INSTANCE_NAME`_PostScanCh1(uint8 sensor) CYREENTRANT;
#endif  /* `$INSTANCE_NAME`_DESIGN_TYPE */

 #if (`$INSTANCE_NAME`_DESIGN_TYPE == `$INSTANCE_NAME`_ONE_CHANNEL_DESIGN)
    extern uint8 `$INSTANCE_NAME`_FindNextSensor(uint8 snsIndex) CYREENTRANT;
    ...
    extern uint8 `$INSTANCE_NAME`_FindNextPair(uint8 snsIndex) CYREENTRANT;
