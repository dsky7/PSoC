...
/* Trigger modes */
#define `$INSTANCE_NAME`_TRIG_RISING                    (`$INSTANCE_NAME`__TRIG_RISING)
#define `$INSTANCE_NAME`_TRIG_FALLING                   (`$INSTANCE_NAME`__TRIG_FALLING)
#define `$INSTANCE_NAME`_TRIG_BOTH                      (`$INSTANCE_NAME`__TRIG_BOTH)
#define `$INSTANCE_NAME`_TRIG_LEVEL                     (`$INSTANCE_NAME`__TRIG_LEVEL)

/* Interrupt mask */
#define `$INSTANCE_NAME`_INTR_MASK_TC                   (`$INSTANCE_NAME`__INTR_MASK_TC)
#define `$INSTANCE_NAME`_INTR_MASK_CC_MATCH             (`$INSTANCE_NAME`__INTR_MASK_CC_MATCH)
...
#define `$INSTANCE_NAME`_PWM_MODE_CENTER                (`$INSTANCE_NAME`_CC_MATCH_INVERT       |   \
                                                         `$INSTANCE_NAME`_OVERLOW_NO_CHANGE     |   \
                                                         `$INSTANCE_NAME`_UNDERFLOW_CLEAR)
#define `$INSTANCE_NAME`_PWM_MODE_ASYM                  (`$INSTANCE_NAME`_CC_MATCH_NO_CHANGE    |   \
                                                         `$INSTANCE_NAME`_OVERLOW_SET           |   \
                                                         `$INSTANCE_NAME`_UNDERFLOW_CLEAR )
