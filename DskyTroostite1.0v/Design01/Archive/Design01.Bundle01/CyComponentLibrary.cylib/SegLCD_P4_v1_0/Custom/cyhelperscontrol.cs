...
namespace SegLCD_P4_v1_0
{
    ...
    public partial class CyHelpers : CyEditingWrapperControl
    {
            ...
            : base(parameters)
        {
            ...
            labelHint.Text = Properties.Resources.TIP_PIXELS_DRAG;
            InitDataGridMap();
        ...
        private void buttonAddHelper_Click(object sender, EventArgs e)
        {
            ...
            if (m_parameters.m_helpersConfig.Count - 1 >= MAX_HELPERS_NUMBER)
            {
                MessageBox.Show(String.Format(Properties.Resources.HELPERS_LIMIT_MSG, MAX_HELPERS_NUMBER),
                                Properties.Resources.WARNING_MSG_TITLE, MessageBoxButtons.OK,
            ...
            if (!fitInSpace)
            {
                MessageBox.Show(Properties.Resources.NOT_ENOUGH_SEG_COM_MSG, Properties.Resources.INFORMATION_MSG_TITLE,
        ...
        private void buttonPrint_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show(Properties.Resources.PRINT_ERROR, Properties.Resources.ERROR_MSG_TITLE,
        ...
        private void printDocumentPixelMap_PrintPage(object sender, System.Drawing.Printing.PrintPageEventArgs e)
        {
            ...
            catch (Exception)
            {
                ...
                m_lastPrintedRow = 0;
                e.HasMorePages = false;
                MessageBox.Show(Properties.Resources.PRINT_TABLE_ERROR_MSG, Properties.Resources.ERROR_MSG_TITLE,
                                MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
