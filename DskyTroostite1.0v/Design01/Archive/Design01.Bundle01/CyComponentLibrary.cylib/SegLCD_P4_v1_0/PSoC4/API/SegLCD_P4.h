...
#define `$INSTANCE_NAME`_DATA0_REG                (* (reg32*) CYREG_LCD_DATA00)
#define `$INSTANCE_NAME`_DATA0_PTR                ((reg32*) CYREG_LCD_DATA00)
#define `$INSTANCE_NAME`_DATA1_REG                (* (reg32*) CYREG_LCD_DATA01)
#define `$INSTANCE_NAME`_DATA1_PTR                ((reg32*) CYREG_LCD_DATA01)
#define `$INSTANCE_NAME`_DATA2_REG                (* (reg32*) CYREG_LCD_DATA02)
#define `$INSTANCE_NAME`_DATA2_PTR                ((reg32*) CYREG_LCD_DATA02)
#define `$INSTANCE_NAME`_DATA3_REG                (* (reg32*) CYREG_LCD_DATA03)
#define `$INSTANCE_NAME`_DATA3_PTR                ((reg32*) CYREG_LCD_DATA03)
#define `$INSTANCE_NAME`_DATA4_REG                (* (reg32*) CYREG_LCD_DATA04)
#define `$INSTANCE_NAME`_DATA4_PTR                ((reg32*) CYREG_LCD_DATA04)
