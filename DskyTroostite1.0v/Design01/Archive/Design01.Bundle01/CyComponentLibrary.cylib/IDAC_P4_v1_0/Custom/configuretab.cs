...
namespace IDAC_P4_v1_0
{
    public partial class CyConfigureTab : UserControl, ICyParamEditingControl
    {
        ...
        public CyConfigureTab(CyParameters parameters)
        {
            ...
            numCurrentValue.TextChanged += new EventHandler(numCurrentValue_TextChanged);
            numCurrentValue.ValueChanged += numCurrentValue_ValueChanged;
            numConvertedValue.TextChanged += new EventHandler(numConvertedValue_TextChanged);
        }
        #endregion
        ...
        void numCurrentValue_ValueChanged(object sender, EventArgs e)
        {
            if (m_params.m_globalEditMode == false)
                return;
        ...
        void numCurrentValue_TextChanged(object sender, EventArgs e)
        {
        ...
        void numConvertedValue_TextChanged(object sender, EventArgs e)
        {
            // Get value from control
        ...
        private void rb8Bit_CheckedChanged(object sender, EventArgs e)
        {
            ...
            m_params.Resolution = (byte)(choise ? CyParamRange.RESOLUTION_8 : CyParamRange.RESOLUTION_7);
        ...
        private void rbLowRange_CheckedChanged(object sender, EventArgs e)
        {
            m_params.IDACRange = (((RadioButton)sender).Checked) ?
                CyEIDACRangeType.LowRange : CyEIDACRangeType.HighRange;
