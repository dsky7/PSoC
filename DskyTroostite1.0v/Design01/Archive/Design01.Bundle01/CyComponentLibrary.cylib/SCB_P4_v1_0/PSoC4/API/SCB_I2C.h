...
#define `$INSTANCE_NAME`_I2C_MODE_MULTI_MASTER_MASK  (0x04u)
    ...
    #define `$INSTANCE_NAME`_CHECK_I2C_WAKE_ENABLE  (0u != `$INSTANCE_NAME`_scbEnableWake)
    ...
    /* Returns true if wakeup on address match is enabled */
    #define `$INSTANCE_NAME`_CHECK_I2C_WAKE_ENABLE  (0u != `$INSTANCE_NAME`_I2C_WAKE_ENABLE)
