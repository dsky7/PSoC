...
#define `$INSTANCE_NAME`_SPI_INTERRUPT_ENABLE   ((`$INSTANCE_NAME`_SPI_INTERRUPT_MODE == \
                                                    `$INSTANCE_NAME`_SCB_INTR_MODE_INTERNAL) ? (1u) : (0u))

/* Enable UART mode interrupt */
#define `$INSTANCE_NAME`_UART_INTERRUPT_ENABLE  ((`$INSTANCE_NAME`_UART_INTERRUPT_MODE == \
                                                    `$INSTANCE_NAME`_SCB_INTR_MODE_INTERNAL) ? (1u) : (0u))
    ...
    #define `$INSTANCE_NAME`_CHECK_UART_WAKE_ENABLE (0u != `$INSTANCE_NAME`_scbEnableWake)
    ...
    /* Get wakeup enable option */
    #define `$INSTANCE_NAME`_CHECK_SPI_WAKE_ENABLE  (0u != `$INSTANCE_NAME`_SPI_WAKE_ENABLE)
    #define `$INSTANCE_NAME`_CHECK_UART_WAKE_ENABLE (0u != `$INSTANCE_NAME`_UART_WAKE_ENABLE)
...
***************************************/
    ...
    /* Interrupt sources */
    #define `$INSTANCE_NAME`_SPI_INTERRUPT_DISABLE          (0u == `$INSTANCE_NAME`_SPI_INTERRUPT_ENABLE)
...
***************************************/
    ...
    /* Interrupt sources */
    #define `$INSTANCE_NAME`_UART_INTERRUPT_DISABLE         (0u == `$INSTANCE_NAME`_UART_INTERRUPT_ENABLE)
