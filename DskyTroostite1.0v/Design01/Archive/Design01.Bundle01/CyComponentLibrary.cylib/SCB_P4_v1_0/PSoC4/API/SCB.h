...
extern `$INSTANCE_NAME`_BACKUP_STRUCT `$INSTANCE_NAME`_backup;
    ...
    /* Common config vars */
    extern volatile uint8 `$INSTANCE_NAME`_scbMode;
    extern volatile uint8 `$INSTANCE_NAME`_scbEnableWake;

    /* I2C config vars */
    extern volatile uint8 `$INSTANCE_NAME`_mode;
    extern volatile uint8 `$INSTANCE_NAME`_acceptAddr;

    /* SPI/UART config vars */
    extern volatile uint8 * `$INSTANCE_NAME`_rxBuffer;
    extern volatile uint8   `$INSTANCE_NAME`_rxDataBits;
    extern volatile uint32  `$INSTANCE_NAME`_rxBufferSize;

    extern volatile uint8 * `$INSTANCE_NAME`_txBuffer;
    extern volatile uint8   `$INSTANCE_NAME`_txDataBits;
    extern volatile uint32  `$INSTANCE_NAME`_txBufferSize;
