    ...
    *******************************************************************************/
    void `$INSTANCE_NAME`_UartInit(void)
    {
        ...
        `$INSTANCE_NAME`_INTR_TX_MASK_REG     = `$INSTANCE_NAME`_UART_DEFAULT_INTR_TX_MASK;
            ...
            #if(`$INSTANCE_NAME`_UART_INTERRUPT_DISABLE)
                `$INSTANCE_NAME`_SCB_IRQ_Disable();
            #endif /* (`$INSTANCE_NAME`_UART_INTERRUPT_DISABLE) */
...
{
    `$Cond`if(`$INSTANCE_NAME`_CHECK_UART_WAKE_ENABLE)
    {
...
void `$INSTANCE_NAME`_UartRestoreConfig(void)
{
    `$Cond`if(`$INSTANCE_NAME`_CHECK_UART_WAKE_ENABLE)
    {
        /* Does nothing: after exit DeepSleep next Start bit handling becomes normal */
