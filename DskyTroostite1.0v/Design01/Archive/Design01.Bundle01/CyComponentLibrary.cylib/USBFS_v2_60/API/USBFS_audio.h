...
extern volatile uint8 `$INSTANCE_NAME`_currentSampleFrequency[`$INSTANCE_NAME`_MAX_EP]
                                                             [`$INSTANCE_NAME`_SAMPLE_FREQ_LEN];
...
#endif /* End CY_USBFS_`$INSTANCE_NAME`_audio_H */
