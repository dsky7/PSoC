...
/* `#END` */
    ...
    ******************************************************************************/
    ...
    {
        #if (defined(`$INSTANCE_NAME`_ENABLE_MIDI_STREAMING) && `$INSTANCE_NAME`_ISR_SERVICE_MIDI_OUT && CY_PSOC3)
            uint8 int_en;
        ...
        #if( defined(`$INSTANCE_NAME`_ENABLE_MIDI_STREAMING) && `$INSTANCE_NAME`_ISR_SERVICE_MIDI_OUT )
            if(`$INSTANCE_NAME`_midi_out_ep == `$INSTANCE_NAME`_EP1)
            {
                `$INSTANCE_NAME`_MIDI_OUT_EP_Service();
            }
        #endif /* End `$INSTANCE_NAME`_ISR_SERVICE_MIDI_OUT */
