...
#define `$INSTANCE_NAME`_SetSpeed(speed)      `$INSTANCE_NAME`_`$DacModeReplString`_SetSpeed(speed)
#define `$INSTANCE_NAME`_SetRange(range)      `$INSTANCE_NAME`_`$DacModeReplString`_SetRange(range)
#define `$INSTANCE_NAME`_SetValue(value)      `$INSTANCE_NAME`_`$DacModeReplString`_SetValue(value)
#define `$INSTANCE_NAME`_DacTrim(void)        `$INSTANCE_NAME`_`$DacModeReplString`_DacTrim()
#define `$INSTANCE_NAME`_SaveConfig(void)     `$INSTANCE_NAME`_`$DacModeReplString`_SaveConfig()
#define `$INSTANCE_NAME`_RestoreConfig(void)  `$INSTANCE_NAME`_`$DacModeReplString`_RestoreConfig()
