...
namespace CharLCD_v2_0
{
    public partial class CyCharLCDControl : UserControl
    {
        ...
        {
            CharLCD_v2_0.CyCustomCharacter current = (CharLCD_v2_0.CyCustomCharacter)sender;
            CharLCD_v2_0.CyBox clickedBox = current.GetBoxByLocation(e.X, e.Y);
            if (clickedBox != null)
            {
        ...
        private void custArray_MouseMove(object sender, MouseEventArgs e)
        {
            ...
            {
                CharLCD_v2_0.CyCustomCharacter current = (CharLCD_v2_0.CyCustomCharacter)sender;
                CharLCD_v2_0.CyBox currentBox = current.GetBoxByLocation(e.X, e.Y);
                if (currentBox != null)
                {
        ...
        {
            CharLCD_v2_0.CyCustomCharacter selectedCharacter = (CharLCD_v2_0.CyCustomCharacter)sender;
        ...
        public void CYStringToCharacter(CyCustomCharacter customCharacter, string cyCharacterString)
        {
            ...
            CharLCD_v2_0.CyBox[,] boxes = customCharacter.GetBoxArray();
        ...
        public string CharacterToCYString(CyCustomCharacter customCharacter)
        {
            ...
            CharLCD_v2_0.CyBox[,] pixelArray = customCharacter.GetBoxArray();
        ...
        private void HighlightNext()
        {
            ...
            UpdateHighlighted((CharLCD_v2_0.CyCustomCharacter)m_userDefinedCharacters[next]);
        }
        ...
        private void HighlightPrevious()
        {
            ...
            // Cast from Object to CustomCharacter
            UpdateHighlighted((CharLCD_v2_0.CyCustomCharacter)m_userDefinedCharacters[previous]);
        }
        ...
        private void HighlightAbove()
        {
            ...
            // Cast from Object to CustomCharacter
            UpdateHighlighted((CharLCD_v2_0.CyCustomCharacter)m_userDefinedCharacters[above]);
        }
        private void HighlightBelow()
        {
            ...
            // Cast from Object to CustomCharacter
            UpdateHighlighted((CharLCD_v2_0.CyCustomCharacter)m_userDefinedCharacters[below]);
        }
        ...
        private void CustomCharactersOff()
        {
            ...
            for (int i = 0; i < this.panel1.Controls.Count; i++)
            {
                CharLCD_v2_0.CyCustomCharacter character = (CharLCD_v2_0.CyCustomCharacter)this.panel1.Controls[i];
