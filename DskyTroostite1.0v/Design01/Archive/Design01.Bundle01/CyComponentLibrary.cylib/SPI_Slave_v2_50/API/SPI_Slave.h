...
***************************************/
    ...
    #define `$INSTANCE_NAME`_TX_AUX_CONTROL_DP0_PTR       (  (reg8 *) \
	    ...
	    #define `$INSTANCE_NAME`_RXDATA_PTR                (  (`$RegDefReplacementString`  *) \
	            `$INSTANCE_NAME`_BSPIS_es3_SPISlave_`$VerilogSectionReplacementString`_Dp_u0__F1_REG)
	#else
		#if(`$INSTANCE_NAME`_DataWidth <= 8u) /* 8bit - SPIS */
			...
			#define `$INSTANCE_NAME`_TXDATA_ZERO_REG           (* (reg16  *) \
		            `$INSTANCE_NAME`_BSPIS_es3_SPISlave_`$VerilogSectionReplacementString`_Dp_u0__16BIT_A0_REG)
		    ...
		    #define `$INSTANCE_NAME`_TXDATA_REG                (* (reg16  *) \
		            `$INSTANCE_NAME`_BSPIS_es3_SPISlave_`$VerilogSectionReplacementString`_Dp_u0__16BIT_F0_REG)

		    #define `$INSTANCE_NAME`_TXDATA_PTR                (  (reg16  *) \
		            `$INSTANCE_NAME`_BSPIS_es3_SPISlave_`$VerilogSectionReplacementString`_Dp_u0__16BIT_F0_REG)

		    #define `$INSTANCE_NAME`_RXDATA_REG                (* (reg16  *) \
		            `$INSTANCE_NAME`_BSPIS_es3_SPISlave_`$VerilogSectionReplacementString`_Dp_u0__16BIT_F1_REG)
