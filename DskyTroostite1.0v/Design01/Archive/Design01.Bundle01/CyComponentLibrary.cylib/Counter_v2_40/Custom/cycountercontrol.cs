...
namespace Counter_v2_40
{
    public partial class CyCounterControl : UserControl
    {
        ...
        private void SetFixedFunction()
        {
            ...
            {
                CyCounterParameters.SetAParameter(Counter_v2_40.CyCounterParameters.INTERRUPT_ON_CAPTURE,
                                                Counter_v2_40.CyCounterParameters.FALSE, m_component);
            }
        }
        ...
        private void m_numPeriod_ValueChanged(object sender, EventArgs e)
        {
            ...
            if (!ce.Cancel)
            {
                ...
                if (m_cbClockMode.SelectedIndex == 2 || m_cbClockMode.SelectedIndex == 3)
                    ...
                    m_numCompare1.Maximum = Counter_v2_40.CyCounterParameters.CONST_2_8;
                else if (m_rbResolution16.Checked)
                    m_numCompare1.Maximum = Counter_v2_40.CyCounterParameters.CONST_2_16;
                else if (m_rbResolution24.Checked)
                    m_numCompare1.Maximum = Counter_v2_40.CyCounterParameters.CONST_2_24;
                else
                    m_numCompare1.Maximum = Counter_v2_40.CyCounterParameters.CONST_2_32;
            }
        }
        ...
        private void m_rbResolution8_Click(object sender, MouseEventArgs e)
        {
            if (!m_rbResolution8.Checked)
            {
                ...
                CyCounterParameters.SetAParameter(Counter_v2_40.CyCounterParameters.RESOLUTION,
                                                Counter_v2_40.CyCounterParameters.EIGHT_BIT, m_component);
            }
        ...
        private void m_rbResolution16_Click(object sender, EventArgs e)
        {
            if (!m_rbResolution16.Checked)
            {
                ...
                m_rbResolution32.Checked = false;
                CyCounterParameters.SetAParameter(Counter_v2_40.CyCounterParameters.RESOLUTION,
                                                Counter_v2_40.CyCounterParameters.SIXTEEN_BIT, m_component);
            }
            m_numPeriod_Validating(sender, new CancelEventArgs());
            m_numCompare1_Validating(sender, new CancelEventArgs());
        }
        ...
        private void m_rbResolution24_Click(object sender, EventArgs e)
        {
            if (!m_rbResolution24.Checked)
            {
                ...
                m_rbResolution32.Checked = false;
                CyCounterParameters.SetAParameter(Counter_v2_40.CyCounterParameters.RESOLUTION,
                                                Counter_v2_40.CyCounterParameters.TWENTYFOUR_BIT, m_component);
            }
            m_numPeriod_Validating(sender, new CancelEventArgs());
            m_numCompare1_Validating(sender, new CancelEventArgs());
        }
        ...
        private void m_rbResolution32_Click(object sender, EventArgs e)
        {
            if (!m_rbResolution32.Checked)
            {
                ...
                CyCounterParameters.SetAParameter(Counter_v2_40.CyCounterParameters.RESOLUTION,
                                                Counter_v2_40.CyCounterParameters.THIRTYTWO_BIT, m_component);
            }
            m_numPeriod_Validating(sender, new CancelEventArgs());
            m_numCompare1_Validating(sender, new CancelEventArgs());
        ...
        private void m_rbFixedFunction_Click(object sender, EventArgs e)
        {
            ...
            SetFixedFunction();
            CyCounterParameters.SetAParameter(Counter_v2_40.CyCounterParameters.FIXEDFUNCTION,
                                            Counter_v2_40.CyCounterParameters.TRUE, m_component);
            UpdateAdvancedForm();
        }
        ...
        {
            if (m_rbResolution8.Checked)
                m_numPeriod.Value = m_cbClockMode.SelectedIndex > 1 ? Counter_v2_40.CyCounterParameters.CONST_2_8 :
                    Counter_v2_40.CyCounterParameters.CONST_2_8 - 1;
            else if (m_rbResolution16.Checked)
                m_numPeriod.Value = m_cbClockMode.SelectedIndex > 1 ? Counter_v2_40.CyCounterParameters.CONST_2_16 :
                    Counter_v2_40.CyCounterParameters.CONST_2_16 - 1;
            else if (m_rbResolution24.Checked)
                m_numPeriod.Value = m_cbClockMode.SelectedIndex > 1 ? Counter_v2_40.CyCounterParameters.CONST_2_24 :
                    Counter_v2_40.CyCounterParameters.CONST_2_24 - 1;
            else
                m_numPeriod.Value = m_cbClockMode.SelectedIndex > 1 ? Counter_v2_40.CyCounterParameters.CONST_2_32 :
                    Counter_v2_40.CyCounterParameters.CONST_2_32 - 1;
        }
        ...
        private void m_bMaxCompareValue_Click(object sender, EventArgs e)
        {
            ...
            {
                m_numCompare1.Maximum = Counter_v2_40.CyCounterParameters.CONST_2_8;
                m_numCompare1.Value = Counter_v2_40.CyCounterParameters.CONST_2_8;
            }
            else if (m_rbResolution16.Checked)
            {
                m_numCompare1.Maximum = Counter_v2_40.CyCounterParameters.CONST_2_16;
                m_numCompare1.Value = Counter_v2_40.CyCounterParameters.CONST_2_16;
            }
            else if (m_rbResolution24.Checked)
            {
                m_numCompare1.Maximum = Counter_v2_40.CyCounterParameters.CONST_2_24;
                m_numCompare1.Value = Counter_v2_40.CyCounterParameters.CONST_2_24;
            }
            else
            {
                m_numCompare1.Maximum = Counter_v2_40.CyCounterParameters.CONST_2_32;
                m_numCompare1.Value = Counter_v2_40.CyCounterParameters.CONST_2_32;
            }
        }
