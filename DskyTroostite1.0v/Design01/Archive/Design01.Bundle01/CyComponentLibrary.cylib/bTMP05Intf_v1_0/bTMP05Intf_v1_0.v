...
`include "cypress.v"
`ifdef bTMP05Intf_v1_0_V_ALREADY_INCLUDED
`else
`define bTMP05Intf_v1_0_V_ALREADY_INCLUDED

module bTMP05Intf_v1_0
(
    input    wire    clk,
    input    wire    en,
    input    wire    sensor,
...
`endif /* bTMP05Intf_v1_0_V_ALREADY_INCLUDED */
