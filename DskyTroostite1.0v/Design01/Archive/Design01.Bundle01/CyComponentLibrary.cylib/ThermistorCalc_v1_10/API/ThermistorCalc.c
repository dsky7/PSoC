...
int16 `$INSTANCE_NAME`_GetTemperature(uint32 resT) `=ReentrantKeil($INSTANCE_NAME . "_GetTemperature")`
{
    ...
    `$lookUpTableString`    
		...
		stEqn = `$INSTANCE_NAME`_THA + `$INSTANCE_NAME`_THB * logrT + `$INSTANCE_NAME`_THC * pow(logrT, 3u);
		tempTR = (int16) ((((1u / stEqn) - `$INSTANCE_NAME`_K2C) * `$INSTANCE_NAME`_SCALE) + 0.5);
        ...
        tempTR = `$INSTANCE_NAME`_MIN_TEMP + (int16) (last * `$INSTANCE_NAME`_ACCURACY);     
