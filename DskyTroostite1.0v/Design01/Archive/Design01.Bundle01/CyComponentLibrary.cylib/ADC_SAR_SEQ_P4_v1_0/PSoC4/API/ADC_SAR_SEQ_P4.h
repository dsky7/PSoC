...
#define `$INSTANCE_NAME`_SAR_CHAN_EN_REG             (*(reg32 *) CYREG_SAR_CHAN_EN )
#define `$INSTANCE_NAME`_SAR_CHAN_EN_PTR             ( (reg32 *) CYREG_SAR_CHAN_EN )

#define `$INSTANCE_NAME`_SAR_START_CTRL_REG          (*(reg32 *) CYREG_SAR_START_CTRL )
#define `$INSTANCE_NAME`_SAR_START_CTRL_PTR          ( (reg32 *) CYREG_SAR_START_CTRL )
...
#define `$INSTANCE_NAME`_SAR_CHAN_CONFIG_REG         (*(reg32 *) CYREG_SAR_CHAN_CONFIG00 )
#define `$INSTANCE_NAME`_SAR_CHAN_CONFIG_PTR         ( (reg32 *) CYREG_SAR_CHAN_CONFIG00 )
#define `$INSTANCE_NAME`_SAR_CHAN_CONFIG_IND         CYREG_SAR_CHAN_CONFIG00

#define `$INSTANCE_NAME`_SAR_CHAN_WORK_REG           (*(reg32 *) CYREG_SAR_CHAN_WORK00 )
#define `$INSTANCE_NAME`_SAR_CHAN_WORK_PTR           ( (reg32 *) CYREG_SAR_CHAN_WORK00 )

#define `$INSTANCE_NAME`_SAR_CHAN_RESULT_REG         (*(reg32 *) CYREG_SAR_CHAN_RESULT00 )
#define `$INSTANCE_NAME`_SAR_CHAN_RESULT_PTR         ( (reg32 *) CYREG_SAR_CHAN_RESULT00 )
#define `$INSTANCE_NAME`_SAR_CHAN_RESULT_IND         CYREG_SAR_CHAN_RESULT00

#define `$INSTANCE_NAME`_SAR_CHAN0_RESULT_REG         (*(reg32 *) CYREG_SAR_CHAN_RESULT00 )
#define `$INSTANCE_NAME`_SAR_CHAN0_RESULT_PTR         ( (reg32 *) CYREG_SAR_CHAN_RESULT00 )

#define `$INSTANCE_NAME`_SAR_CHAN1_RESULT_REG         (*(reg32 *) CYREG_SAR_CHAN_RESULT01 )
#define `$INSTANCE_NAME`_SAR_CHAN1_RESULT_PTR         ( (reg32 *) CYREG_SAR_CHAN_RESULT01 )

#define `$INSTANCE_NAME`_SAR_CHAN2_RESULT_REG         (*(reg32 *) CYREG_SAR_CHAN_RESULT02 )
#define `$INSTANCE_NAME`_SAR_CHAN2_RESULT_PTR         ( (reg32 *) CYREG_SAR_CHAN_RESULT02 )

#define `$INSTANCE_NAME`_SAR_CHAN3_RESULT_REG         (*(reg32 *) CYREG_SAR_CHAN_RESULT03 )
#define `$INSTANCE_NAME`_SAR_CHAN3_RESULT_PTR         ( (reg32 *) CYREG_SAR_CHAN_RESULT03 )

#define `$INSTANCE_NAME`_SAR_CHAN4_RESULT_REG         (*(reg32 *) CYREG_SAR_CHAN_RESULT04 )
#define `$INSTANCE_NAME`_SAR_CHAN4_RESULT_PTR         ( (reg32 *) CYREG_SAR_CHAN_RESULT04 )

#define `$INSTANCE_NAME`_SAR_CHAN5_RESULT_REG         (*(reg32 *) CYREG_SAR_CHAN_RESULT05 )
#define `$INSTANCE_NAME`_SAR_CHAN5_RESULT_PTR         ( (reg32 *) CYREG_SAR_CHAN_RESULT05 )

#define `$INSTANCE_NAME`_SAR_CHAN6_RESULT_REG         (*(reg32 *) CYREG_SAR_CHAN_RESULT06 )
#define `$INSTANCE_NAME`_SAR_CHAN6_RESULT_PTR         ( (reg32 *) CYREG_SAR_CHAN_RESULT06 )

#define `$INSTANCE_NAME`_SAR_CHAN7_RESULT_REG         (*(reg32 *) CYREG_SAR_CHAN_RESULT07 )
#define `$INSTANCE_NAME`_SAR_CHAN7_RESULT_PTR         ( (reg32 *) CYREG_SAR_CHAN_RESULT07 )

#define `$INSTANCE_NAME`_SAR_CHAN_WORK_VALID_REG     (*(reg32 *) CYREG_SAR_CHAN_WORK_VALID)
#define `$INSTANCE_NAME`_SAR_CHAN_WORK_VALID_PTR     ( (reg32 *) CYREG_SAR_CHAN_WORK_VALID)

#define `$INSTANCE_NAME`_SAR_CHAN_RESULT_VALID_REG   ( *(reg32 *) CYREG_SAR_CHAN_RESULT_VALID )
#define `$INSTANCE_NAME`_SAR_CHAN_RESULT_VALID_PTR   ( (reg32 *) CYREG_SAR_CHAN_RESULT_VALID )
...
#define `$INSTANCE_NAME`_SAR_SATURATE_INTR_REG       (*(reg32 *) CYREG_SAR_SATURATE_INTR )
#define `$INSTANCE_NAME`_SAR_SATURATE_INTR_PTR       ( (reg32 *) CYREG_SAR_SATURATE_INTR )
...
#define `$INSTANCE_NAME`_SAR_RANGE_INTR_REG          (*(reg32 *) CYREG_SAR_RANGE_INTR )
#define `$INSTANCE_NAME`_SAR_RANGE_INTR_PTR          ( (reg32 *) CYREG_SAR_RANGE_INTR )
...
#define `$INSTANCE_NAME`_SAR_INJ_CHAN_CONFIG_REG     (*(reg32 *) CYREG_SAR_INJ_CHAN_CONFIG)
#define `$INSTANCE_NAME`_SAR_INJ_CHAN_CONFIG_PTR     ( (reg32 *) CYREG_SAR_INJ_CHAN_CONFIG)

#define `$INSTANCE_NAME`_SAR_INJ_RESULT_REG          (*(reg32 *) CYREG_SAR_INJ_RESULT )
#define `$INSTANCE_NAME`_SAR_INJ_RESULT_PTR          ( (reg32 *) CYREG_SAR_INJ_RESULT )
...
#define `$INSTANCE_NAME`_VREF_INTERNALVREF          (0x00000000Lu)
#define `$INSTANCE_NAME`_VREF_INTERNALVREFBYPASSED  (0x00000000Lu)
...
#define `$INSTANCE_NAME`_DEFAULT_POWER \
       ((`$INSTANCE_NAME`_NOMINAL_CLOCK_FREQ > (`$INSTANCE_NAME`_MAX_FREQUENCY / 2)) ? `$INSTANCE_NAME`_NORMAL_PWR : \
       ((`$INSTANCE_NAME`_NOMINAL_CLOCK_FREQ > (`$INSTANCE_NAME`_MAX_FREQUENCY / 4)) ? `$INSTANCE_NAME`_HALF_PWR : \
