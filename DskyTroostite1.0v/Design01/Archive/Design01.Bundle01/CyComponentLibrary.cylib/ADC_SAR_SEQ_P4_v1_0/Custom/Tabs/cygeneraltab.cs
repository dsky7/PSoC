            ...
            if (m_params.GlobalEditMode)
            {
                if (sender == m_numLowLimit || sender == m_numHighLimit)
                {
                    ...
                    try
                    {
                        ...
                        if (m_params.LowLimit >= m_params.HighLimit)
                        {
                            throw new Exception();
                        }
                    ...
                    {
                        m_errorProvider.SetError(m_numLowLimit, Resources.LowLimitErrorDescription);
                        m_errorProvider.SetError(m_numHighLimit, Resources.HighLimitErrorDescription);
                    }
                }
