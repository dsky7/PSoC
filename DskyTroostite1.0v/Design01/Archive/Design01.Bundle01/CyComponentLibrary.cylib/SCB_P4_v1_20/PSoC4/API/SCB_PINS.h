...
#if(`$INSTANCE_NAME`_MOSI_SCL_RX_PIN)
    #define `$INSTANCE_NAME`_MOSI_SCL_RX_HSIOM_REG      (*(reg32 *) `$INSTANCE_NAME`_`$PinName0Unconfig`__0__HSIOM)
    #define `$INSTANCE_NAME`_MOSI_SCL_RX_HSIOM_PTR      ( (reg32 *) `$INSTANCE_NAME`_`$PinName0Unconfig`__0__HSIOM)
    #define `$INSTANCE_NAME`_MOSI_SCL_RX_HSIOM_MASK     (`$INSTANCE_NAME`_`$PinName0Unconfig`__0__HSIOM_MASK)
    #define `$INSTANCE_NAME`_MOSI_SCL_RX_HSIOM_POS      (`$INSTANCE_NAME`_`$PinName0Unconfig`__0__HSIOM_SHIFT)
#endif /* (`$INSTANCE_NAME`_MOSI_SCL_RX_PIN) */

#if(`$INSTANCE_NAME`_MISO_SDA_TX_PIN)
    #define `$INSTANCE_NAME`_MISO_SDA_TX_HSIOM_REG      (*(reg32 *) `$INSTANCE_NAME`_`$PinName1Unconfig`__0__HSIOM)
    #define `$INSTANCE_NAME`_MISO_SDA_TX_HSIOM_PTR      ( (reg32 *) `$INSTANCE_NAME`_`$PinName1Unconfig`__0__HSIOM)
    #define `$INSTANCE_NAME`_MISO_SDA_TX_HSIOM_MASK     (`$INSTANCE_NAME`_`$PinName1Unconfig`__0__HSIOM_MASK)
    #define `$INSTANCE_NAME`_MISO_SDA_TX_HSIOM_POS      (`$INSTANCE_NAME`_`$PinName1Unconfig`__0__HSIOM_SHIFT)
#endif /* (`$INSTANCE_NAME`_MISO_SDA_TX_PIN_PIN) */
...
#define `$INSTANCE_NAME`_MOSI_SCL_RX_PIN_MASK      ((uint32) 0x01u << `$INSTANCE_NAME`_MOSI_SCL_RX_PIN_INDEX)
#define `$INSTANCE_NAME`_MOSI_SCL_RX_WAKE_PIN_MASK ((uint32) 0x01u << `$INSTANCE_NAME`_MOSI_SCL_RX_WAKE_PIN_INDEX)
#define `$INSTANCE_NAME`_MISO_SDA_TX_PIN_MASK      ((uint32) 0x01u << `$INSTANCE_NAME`_MISO_SDA_TX_PIN_INDEX)
#define `$INSTANCE_NAME`_SCLK_PIN_MASK             ((uint32) 0x01u << `$INSTANCE_NAME`_SCLK_PIN_INDEX)
#define `$INSTANCE_NAME`_SS0_PIN_MASK              ((uint32) 0x01u << `$INSTANCE_NAME`_SS0_PIN_INDEX)
...
/* Unconfigured SCB: scl signal */
#elif(`$INSTANCE_NAME`_MOSI_SCL_RX_WAKE_PIN)
    ...
    #define `$INSTANCE_NAME`_WAIT_SCL_SET_HIGH  (0u == `$INSTANCE_NAME`_spi_mosi_i2c_scl_uart_rx_wake_Read())
...
#elif(`$INSTANCE_NAME`_MISO_SDA_TX_PIN)
