...
#define `$INSTANCE_NAME`_I2C_FSM_SL_WR          (0x12u) /* Slave write states */
#define `$INSTANCE_NAME`_I2C_FSM_SL_RD          (0x11u) /* Slave read  states */
#define `$INSTANCE_NAME`_I2C_FSM_RD             (0x01u) /* FSM slave or master read state */
...
#define `$INSTANCE_NAME`_CHECK_I2C_FSM_RD   (0u != (`$INSTANCE_NAME`_I2C_FSM_RD  & `$INSTANCE_NAME`_state))
