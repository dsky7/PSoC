...
#define `$INSTANCE_NAME`_CY_SCBIP_V1 (CYIPBLOCK_m0s8scb_VERSION >= 1u)
    ...
    #define `$INSTANCE_NAME`_CY_SCBIP_V1_I2C_ONLY   (1u) /* SCB IP V1 supports only I2C */
#else
    #define `$INSTANCE_NAME`_CY_SCBIP_V1_I2C_ONLY   (0u) /* SCB IP V0 supports I2C, SPI, UART */
...
#define `$INSTANCE_NAME`_TX_FIFO_STATUS_RD_PTR_MASK ((uint32) 0x07u << `$INSTANCE_NAME`_TX_FIFO_STATUS_RD_PTR_POS)
#define `$INSTANCE_NAME`_TX_FIFO_STATUS_WR_PTR_MASK ((uint32) 0x07u << `$INSTANCE_NAME`_TX_FIFO_STATUS_WR_PTR_POS)
...
#define `$INSTANCE_NAME`_RX_FIFO_STATUS_RD_PTR_MASK ((uint32) 0x07u << `$INSTANCE_NAME`_RX_FIFO_STATUS_RD_PTR_POS)
#define `$INSTANCE_NAME`_RX_FIFO_STATUS_WR_PTR_MASK ((uint32) 0x07u << `$INSTANCE_NAME`_RX_FIFO_STATUS_WR_PTR_POS)
