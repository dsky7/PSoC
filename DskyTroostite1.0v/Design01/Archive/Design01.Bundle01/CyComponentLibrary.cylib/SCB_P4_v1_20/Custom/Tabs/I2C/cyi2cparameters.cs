...
namespace SCB_P4_v1_20
{
    ...
    public partial class CyParamRanges
    {
        ...
        {
            return medianFilterEnabled ? I2C_OVS_FACTOR_MEDFILTER_MIN : I2C_OVS_FACTOR_NOMEDFILTER_MIN;
        }

        public static byte GetI2COvsLowMinimum(bool medianFilterEnabled)
        {
            return medianFilterEnabled ? I2C_OVS_LOW_MEDFILTER_MIN : I2C_OVS_LOW_NOMEDFILTER_MIN;
        }

        public static byte GetI2COvsHighMinimum(bool medianFilterEnabled)
        {
            return medianFilterEnabled ? I2C_OVS_HIGH_MEDFILTER_MIN : I2C_OVS_HIGH_NOMEDFILTER_MIN;
        }
