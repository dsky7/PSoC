...
namespace SCB_P4_v1_20
{
    ...
    public partial class CyParameters
    {
        ...
        public bool IsScbIPV1
        {
            get { return m_inst.DeviceQuery.GetFeatureVersion("m0s8scb") == 1; }
        }
        #endregion
        ...
        public void UpdateTabVisibility()
        {
            ...
            List<string> visiblePageList = GetVisiblePageList(SCBMode);
            for (int i = 0; i < visiblePageList.Count; i++)
            {
                m_editor.ShowCustomPage(visiblePageList[i]);
            }
        }

        public List<string> GetVisiblePageList(CyESCBMode scbMode)
        {
            List<string> pageList = new List<string>();
            switch (SCBMode)
            {
                case CyESCBMode.UNCONFIG:
                    pageList.Add(Resources.SCBTabDisplayName);
                    break;
                case CyESCBMode.I2C:
                    pageList.Add(Resources.I2CTabDisplayName);
                    break;
                case CyESCBMode.UART:
                    pageList.Add(Resources.UARTConfigTabDisplayName);
                    pageList.Add(Resources.UARTAdvancedTabDisplayName);
                    break;
                case CyESCBMode.SPI:
                    pageList.Add(Resources.SPIBasicTabDisplayName);
                    pageList.Add(Resources.SPIAdvancedTabDisplayName);
                    break;
                case CyESCBMode.EZI2C:
                    pageList.Add(Resources.EZI2CTabDisplayName);
                    break;
            }
            return pageList;
        }
        ...
        public List<CyCustErr> VerifySFSettings()
        {
