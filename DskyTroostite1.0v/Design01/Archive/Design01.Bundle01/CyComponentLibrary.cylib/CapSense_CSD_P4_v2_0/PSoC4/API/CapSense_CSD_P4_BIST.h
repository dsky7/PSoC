...
extern reg32* const `$INSTANCE_NAME`_prtSelTbl[];
extern reg32* const `$INSTANCE_NAME`_prtCfgTbl[];
extern reg32* const `$INSTANCE_NAME`_prtDRTbl[];
extern reg32 * `$INSTANCE_NAME`_pcTable[];

extern const uint8  `$INSTANCE_NAME`_portTable[];
extern const uint32 `$INSTANCE_NAME`_maskTable[];
extern const uint8  `$INSTANCE_NAME`_pinShiftTbl[];
