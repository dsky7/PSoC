...
namespace SMBusSlave_v3_0
{
    ...
    public class CyParamName
    {
        ...
        public const string I2C_MEDIAN_FILTER = "I2cMedianFilterEnable";
    }
    #endregion
    ...
    public class CyParamRange
    {
        ...
        {
            return medianFilterEnabled ? I2C_OVS_FACTOR_MEDFILTER_MIN :
                I2C_OVS_FACTOR_NOMEDFILTER_MIN;
        }
    }
    #endregion
    ...
    public class CyParameters
    {
        ...
        {
            get { return GetValue<byte>(CyParamName.I2C_OVS_FACTOR); }
            set { SetValue(CyParamName.I2C_OVS_FACTOR, value); }
        }
        ...
        {
            get { return GetValue<bool>(CyParamName.I2C_MEDIAN_FILTER); }
            set { SetValue(CyParamName.I2C_MEDIAN_FILTER, value); }
        }
        ...
        {
            CyDividerCalculator.CalculateTimeout(InstQuery, m_termQuery);
        }
        #endregion
    }
