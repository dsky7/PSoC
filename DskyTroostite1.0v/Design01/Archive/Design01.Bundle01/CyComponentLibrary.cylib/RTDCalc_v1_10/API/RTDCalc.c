...
{
    uint8 i;
    float res_norm = `$INSTANCE_NAME`_INIT;
        ...
        ((`$INSTANCE_NAME`_RTD_TYPE == `$INSTANCE_NAME`__PT1000) && (res > `$INSTANCE_NAME`_ZERO_VAL_PT1000)))
    {
        ...
        {
            temp = (`$INSTANCE_NAME`_coeffPos[i] + temp) * res_norm;
        }
    ...
    else
    {
        ...
        {
            temp = (`$INSTANCE_NAME`_coeffNeg[i] + temp) * res_norm;
        }
