...
* Parameters:
*  uint8 speedMode
*    Valid values: `$INSTANCE_NAME`_LOW_SPEED, `$INSTANCE_NAME`_HIGH_SPEED.
*
* Return:
*  None
*
...
{    
        ...
        #if(`$INSTANCE_NAME`_External_Reference == 0u)
             `$INSTANCE_NAME`_VDAC_OV_SetSpeed(speedMode);
             `$INSTANCE_NAME`_VDAC_UV_SetSpeed(speedMode);
             `$INSTANCE_NAME`_Comp_OV_SetSpeed(speedMode);
             `$INSTANCE_NAME`_Comp_UV_SetSpeed(speedMode);
        #else
            `$INSTANCE_NAME`_Comp_OV_SetSpeed(speedMode);
            `$INSTANCE_NAME`_Comp_UV_SetSpeed(speedMode);    
        #endif /* `$INSTANCE_NAME`_External_Reference == 0u */
