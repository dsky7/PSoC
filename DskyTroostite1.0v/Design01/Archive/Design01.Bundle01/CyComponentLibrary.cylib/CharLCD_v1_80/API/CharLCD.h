...
#define `$INSTANCE_NAME`_PORT_MASK                (`$INSTANCE_NAME`_LCDPort__MASK)
    ...
    */
    #define `$INSTANCE_NAME`_HIGH_Z_DATA_DM           (0x00000249ul)
    #define `$INSTANCE_NAME`_STRONG_DATA_DM           (0x00000DB6ul)
    #define `$INSTANCE_NAME`_DM_DATA_MASK             (0xFFFul << (`$INSTANCE_NAME`_PORT_SHIFT * 3u))
...
/* Pin Masks */
#define `$INSTANCE_NAME`_RS                       ((uint8) (((uint8) 0x20u) << `$INSTANCE_NAME`_LCDPort__SHIFT))
#define `$INSTANCE_NAME`_RW                       ((uint8) (((uint8) 0x40u) << `$INSTANCE_NAME`_LCDPort__SHIFT))
#define `$INSTANCE_NAME`_E                        ((uint8) (((uint8) 0x10u) << `$INSTANCE_NAME`_LCDPort__SHIFT))
#define `$INSTANCE_NAME`_READY_BIT                ((uint8) (((uint8) 0x08u) << `$INSTANCE_NAME`_LCDPort__SHIFT))
#define `$INSTANCE_NAME`_DATA_MASK                ((uint8) (((uint8) 0x0Fu) << `$INSTANCE_NAME`_LCDPort__SHIFT))
