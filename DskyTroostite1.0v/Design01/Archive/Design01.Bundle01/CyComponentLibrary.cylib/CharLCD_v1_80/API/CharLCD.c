...
void `$INSTANCE_NAME`_IsReady(void) `=ReentrantKeil($INSTANCE_NAME . "_IsReady")`
{
    ...
    /* Clear the LCD port*/
    `$INSTANCE_NAME`_PORT_DR_REG &= ((uint8)(~`$INSTANCE_NAME`_PORT_MASK));
    ...
    */
        ...
        value = `$INSTANCE_NAME`_PORT_PC_REG & ((uint8)(~ `$INSTANCE_NAME`_DM_DATA_MASK));
    ...
    /* Make sure RS is low */
    `$INSTANCE_NAME`_PORT_DR_REG &= ((uint8)(~`$INSTANCE_NAME`_RS));
    ...
    do
    {
        ...
        /* Set enable low */
        `$INSTANCE_NAME`_PORT_DR_REG &= ((uint8)(~`$INSTANCE_NAME`_E));
    ...
    `$INSTANCE_NAME`_PORT_DR_REG &= ((uint8)(~`$INSTANCE_NAME`_RW));
...
static void `$INSTANCE_NAME`_WrDatNib(uint8 nibble) `=ReentrantKeil($INSTANCE_NAME . "_WrDatNib")`
{
    ...
    /* Clear data pins */
    `$INSTANCE_NAME`_PORT_DR_REG &= ((uint8)(~`$INSTANCE_NAME`_DATA_MASK));
...
static void `$INSTANCE_NAME`_WrCntrlNib(uint8 nibble) `=ReentrantKeil($INSTANCE_NAME . "_WrCntrlNib")`
{
    ...
    `$INSTANCE_NAME`_PORT_DR_REG &= ((uint8)(~(`$INSTANCE_NAME`_RS | `$INSTANCE_NAME`_RW)));
