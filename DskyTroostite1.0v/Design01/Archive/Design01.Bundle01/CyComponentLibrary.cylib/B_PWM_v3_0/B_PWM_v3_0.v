...
`include "cypress.v"
`ifdef B_PWM_V_v3_0_ALREADY_INCLUDED
`else
`define B_PWM_V_v3_0_ALREADY_INCLUDED
module B_PWM_v3_0 (
    ...
    generate
		...
		begin : sDBen
			...
			begin
				pwm_db_reg <= pwm_db;
				ph1_reg_i <= ph1_i;// & final_enable;
				ph2_reg_i <= ph2_i;// & !final_kill;
			end
...
`endif /* B_PWM_V_v3_0_ALREADY_INCLUDED */
