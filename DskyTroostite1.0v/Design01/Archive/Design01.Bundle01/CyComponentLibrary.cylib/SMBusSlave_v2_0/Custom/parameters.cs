...
namespace SMBusSlave_v2_0
{
    ...
    public class CyParameters
    {
        ...
        {
            m_inst = inst;
            m_isBootloader = CyParameters.IsBootloader(m_inst.DesignQuery.ApplicationType);
        ...
        {
            bool result = true;
            if (this.m_inst.DesignQuery.ApplicationType != CyApplicationType_v1.Bootloadable)
            {
