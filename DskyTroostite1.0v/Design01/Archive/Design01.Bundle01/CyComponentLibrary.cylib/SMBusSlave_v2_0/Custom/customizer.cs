...
namespace SMBusSlave_v2_0
{
    ...
    public class CyCustomizer : ICyParamEditHook_v1, ICyAPICustomize_v1, ICyDRCProvider_v1
    {
            ...
            IEnumerable<CyAPICustomizer> apis)
        {
            ...
            // Generate structure
            string regStructure = "typedef struct" + (query.DeviceQuery.IsPSoC5 ? " __attribute__((packed))" : "") + NEW_LINE +
                "{" + NEW_LINE +
            ...
            {
                regStructure += GetStructureField(null,
        ...
        private string GetWriteHandlerCaseBody_PageCmd()
        {
            ...
            sb.AppendFormat("{0}        ({2}_CMD_ALL_PAGES == {2}_cmdPage)){1}", TAB_4, NEW_LINE, m_instName);
            sb.AppendFormat("{0}{{{1}", TAB_4, NEW_LINE);
