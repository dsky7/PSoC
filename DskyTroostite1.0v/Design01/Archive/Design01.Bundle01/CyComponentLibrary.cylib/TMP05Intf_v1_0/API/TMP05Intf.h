...
#define `$INSTANCE_NAME`_FIFO_AUXCTL_REG    (* (reg16 *) `$INSTANCE_NAME`_bTMP05Intf_1_Tmp05Timer_u0__DP_AUX_CTL_REG)
#define `$INSTANCE_NAME`_FIFO_AUXCTL_PTR    (  (reg16 *) `$INSTANCE_NAME`_bTMP05Intf_1_Tmp05Timer_u0__DP_AUX_CTL_REG)
