...
namespace CSD_TunerIntf_v1_10
{
    public partial class CyBinaryGrid : UserControl
    {
        ...
        public void SetErrorListItem(int index, bool state)
        {
            if ((index < 0) || (index > m_errorList.Length)) return;

            m_errorList[index] = state;
        ...
        private void UpdateGridError(int index)
        {
            ...
            if (m_errorList[index] && ((m_labelList[index].Text == OneSign) || (m_labelList[index].Text == XSign)))
