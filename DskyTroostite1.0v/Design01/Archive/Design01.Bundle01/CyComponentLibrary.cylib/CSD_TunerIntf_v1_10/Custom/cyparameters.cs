...
namespace CSD_TunerIntf_v1_10
{
    ...
    public partial class CyParameters
    {
        ...
        public CyI2CTab m_ezI2CTab;

        #region Enumerations
        public CyEnum<CyEEZOperationalMode> m_ezI2COperationalMode;
        public CyEnum<CyEEZOperationalMode> m_ezSPIOperationalMode;
        #endregion
        ...
        public CyParameters(ICyInstQuery_v1 inst)
        {
            ...
            m_ezI2COperationalMode = new CyEnum<CyEEZOperationalMode>(this, CyParamNames.EZI2C_OPERATION_MODE);
        }
        #endregion
