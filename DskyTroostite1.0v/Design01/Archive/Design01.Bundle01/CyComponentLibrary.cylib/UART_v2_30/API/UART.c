...
void `$INSTANCE_NAME`_Init(void) `=ReentrantKeil($INSTANCE_NAME . "_Init")`
{
        ...
        /* Write Counter Value for TX Bit Clk Generator*/
            ...
            `$INSTANCE_NAME`_TXBITCLKTX_COMPLETE_REG = (`$INSTANCE_NAME`_NUMBER_OF_DATA_BITS +
                        `$INSTANCE_NAME`_NUMBER_OF_START_BIT) * `$INSTANCE_NAME`_OVER_SAMPLE_COUNT;
        #else
        ...
        `$INSTANCE_NAME`_WriteControlRegister( \
            (`$INSTANCE_NAME`_ReadControlRegister() & (uint8)~`$INSTANCE_NAME`_CTRL_PARITY_TYPE_MASK) | \
            (uint8)(`$INSTANCE_NAME`_PARITY_TYPE << `$INSTANCE_NAME`_CTRL_PARITY_TYPE0_SHIFT) );
...
void `$INSTANCE_NAME`_Stop(void) `=ReentrantKeil($INSTANCE_NAME . "_Stop")`
{
    ...
    #if(`$INSTANCE_NAME`_RX_ENABLED || `$INSTANCE_NAME`_HD_ENABLED)
        `$INSTANCE_NAME`_RXBITCTR_CONTROL_REG &= (uint8)~`$INSTANCE_NAME`_CNTR_ENABLE;
    #endif /* End `$INSTANCE_NAME`_RX_ENABLED */

    #if(`$INSTANCE_NAME`_TX_ENABLED)
        #if(!`$INSTANCE_NAME`_TXCLKGEN_DP)
            `$INSTANCE_NAME`_TXBITCTR_CONTROL_REG &= (uint8)~`$INSTANCE_NAME`_CNTR_ENABLE;
        #endif /* End `$INSTANCE_NAME`_TXCLKGEN_DP */
    ...
    #if(`$INSTANCE_NAME`_RX_ENABLED || `$INSTANCE_NAME`_HD_ENABLED)
        `$INSTANCE_NAME`_RXSTATUS_ACTL_REG  &= (uint8)~`$INSTANCE_NAME`_INT_ENABLE;
        #if(`$INSTANCE_NAME`_RX_INTERRUPT_ENABLED && (`$INSTANCE_NAME`_RXBUFFERSIZE > `$INSTANCE_NAME`_FIFO_LENGTH))
    ...
    #if(`$INSTANCE_NAME`_TX_ENABLED)
        `$INSTANCE_NAME`_TXSTATUS_ACTL_REG &= (uint8)~`$INSTANCE_NAME`_INT_ENABLE;
        #if(`$INSTANCE_NAME`_TX_INTERRUPT_ENABLED && (`$INSTANCE_NAME`_TXBUFFERSIZE > `$INSTANCE_NAME`_FIFO_LENGTH))
...
void  `$INSTANCE_NAME`_WriteControlRegister(uint8 control) `=ReentrantKeil($INSTANCE_NAME . "_WriteControlRegister")`
{
    ...
    *******************************************************************************/
    uint8 `$INSTANCE_NAME`_ReadRxData(void) `=ReentrantKeil($INSTANCE_NAME . "_ReadRxData")`
    {
        uint8 rxData;
            ...
            `$RxBuffRegSizeReplacementString` loc_rxBufferRead;
            `$RxBuffRegSizeReplacementString` loc_rxBufferWrite;
            /* Protect variables that could change on interrupt. */
            /* Disable Rx interrupt. */
            #if(`$INSTANCE_NAME`_RX_INTERRUPT_ENABLED)
                `$INSTANCE_NAME`_DisableRxInt();
            #endif /* `$INSTANCE_NAME`_RX_INTERRUPT_ENABLED */
            loc_rxBufferRead = `$INSTANCE_NAME`_rxBufferRead;
            loc_rxBufferWrite = `$INSTANCE_NAME`_rxBufferWrite;

            if( (`$INSTANCE_NAME`_rxBufferLoopDetect != 0u) || (loc_rxBufferRead != loc_rxBufferWrite) )
            {
                rxData = `$INSTANCE_NAME`_rxBuffer[loc_rxBufferRead];
                loc_rxBufferRead++;

                if(loc_rxBufferRead >= `$INSTANCE_NAME`_RXBUFFERSIZE)
                {
                    loc_rxBufferRead = 0u;
                }
                /* Update the real pointer */
                `$INSTANCE_NAME`_rxBufferRead = loc_rxBufferRead;
    ...
    *******************************************************************************/
    void `$INSTANCE_NAME`_ClearRxBuffer(void) `=ReentrantKeil($INSTANCE_NAME . "_ClearRxBuffer")`
    {
        ...
        `$INSTANCE_NAME`_RXDATA_AUX_CTL_REG &= (uint8)~`$INSTANCE_NAME`_RX_FIFO_CLR;
    ...
    *******************************************************************************/
                                                        ...
                                                        `=ReentrantKeil($INSTANCE_NAME . "_SetRxAddressMode")`
    {
                ...
                uint8 tmpCtrl;
                tmpCtrl = `$INSTANCE_NAME`_CONTROL_REG & (uint8)~`$INSTANCE_NAME`_CTRL_RXADDR_MODE_MASK;
                tmpCtrl |= (uint8)(addressMode << `$INSTANCE_NAME`_CTRL_RXADDR_MODE0_SHIFT);
    ...
    *******************************************************************************/
    void `$INSTANCE_NAME`_PutChar(uint8 txDataByte) `=ReentrantKeil($INSTANCE_NAME . "_PutChar")`
    {
                ...
                */
                `$TxBuffRegSizeReplacementString` loc_txBufferWrite;
                `$TxBuffRegSizeReplacementString` loc_txBufferRead;

                do{
                    /* Block if software buffer is full, so we don't overwrite. */
                    #if ((`$INSTANCE_NAME`_TXBUFFERSIZE > `$INSTANCE_NAME`_MAX_BYTE_VALUE) && (CY_PSOC3))
                        /* Disable TX interrupt to protect variables that could change on interrupt */
                        CyIntDisable(`$INSTANCE_NAME`_TX_VECT_NUM);
                    #endif /* End TXBUFFERSIZE > 255 */
                    loc_txBufferWrite = `$INSTANCE_NAME`_txBufferWrite;
                    loc_txBufferRead = `$INSTANCE_NAME`_txBufferRead;
                    #if ((`$INSTANCE_NAME`_TXBUFFERSIZE > `$INSTANCE_NAME`_MAX_BYTE_VALUE) && (CY_PSOC3))
                        ...
                        CyIntEnable(`$INSTANCE_NAME`_TX_VECT_NUM);
                                        ...
                                        (`$TxBuffRegSizeReplacementString`)(`$INSTANCE_NAME`_TXBUFFERSIZE - 1u)) );
                ...
                {
                    if(loc_txBufferWrite >= `$INSTANCE_NAME`_TXBUFFERSIZE)
                    {
                        loc_txBufferWrite = 0u;
                    }
                    /* Add to the software buffer. */
                    `$INSTANCE_NAME`_txBuffer[loc_txBufferWrite] = txDataByte;
                    loc_txBufferWrite++;
                    ...
                    /* Finally, update the real output pointer */
                        ...
                        CyIntDisable(`$INSTANCE_NAME`_TX_VECT_NUM);
                    #endif /* End TXBUFFERSIZE > 255 */
                    `$INSTANCE_NAME`_txBufferWrite = loc_txBufferWrite;
                    #if ((`$INSTANCE_NAME`_TXBUFFERSIZE > `$INSTANCE_NAME`_MAX_BYTE_VALUE) && (CY_PSOC3))
                        CyIntEnable(`$INSTANCE_NAME`_TX_VECT_NUM);
                    #endif /* End TXBUFFERSIZE > 255 */
                }
    ...
    *******************************************************************************/
    void `$INSTANCE_NAME`_PutString(const char8 string[]) `=ReentrantKeil($INSTANCE_NAME . "_PutString")`
    {
        ...
        if(`$INSTANCE_NAME`_initVar != 0u)
        {
            ...
            {
                `$INSTANCE_NAME`_PutChar((uint8)string[buf_index]);
                buf_index++;
            }
        }
    }
    ...
    *******************************************************************************/
    ...
    {
        `$TxBuffRegSizeReplacementString` buf_index = 0u;
        /* If not Initialized then skip this function*/
        if(`$INSTANCE_NAME`_initVar != 0u)
        {
            do
            {
                `$INSTANCE_NAME`_PutChar(string[buf_index]);
                buf_index++;
    ...
    *******************************************************************************/
    void `$INSTANCE_NAME`_ClearTxBuffer(void) `=ReentrantKeil($INSTANCE_NAME . "_ClearTxBuffer")`
    {
        ...
        `$INSTANCE_NAME`_TXDATA_AUX_CTL_REG &= (uint8)~`$INSTANCE_NAME`_TX_FIFO_CLR;
        /* Exit critical section */
        CyExitCriticalSection(enableInterrupts);
        ...
        if(`$INSTANCE_NAME`_initVar != 0u)
        {
            ...
            uint8 tmpStat;
                    ...
                    (retMode == `$INSTANCE_NAME`_SEND_WAIT_REINIT) )
                {
                    ...
                    {
                        tmpStat = `$INSTANCE_NAME`_TXSTATUS_REG;
                    }while(((uint8)~tmpStat & `$INSTANCE_NAME`_TX_STS_COMPLETE) != 0u);
                }
                ...
                {
                    `$INSTANCE_NAME`_WriteControlRegister(`$INSTANCE_NAME`_ReadControlRegister() &
                                                  (uint8)~`$INSTANCE_NAME`_CTRL_HD_SEND_BREAK);
                }
    ...
    *******************************************************************************/
    void `$INSTANCE_NAME`_SetTxAddressMode(uint8 addressMode) `=ReentrantKeil($INSTANCE_NAME . "_SetTxAddressMode")`
    {
        ...
        else
        {
            #if( `$INSTANCE_NAME`_CONTROL_REG_REMOVED == 0u )
                `$INSTANCE_NAME`_WriteControlRegister(`$INSTANCE_NAME`_ReadControlRegister() &
                                                    (uint8)~`$INSTANCE_NAME`_CTRL_MARK);
            #endif /* End `$INSTANCE_NAME`_CONTROL_REG_REMOVED == 0u */
        }
    }
    ...
    *******************************************************************************/
    ...
    {
        `$INSTANCE_NAME`_WriteControlRegister(`$INSTANCE_NAME`_ReadControlRegister() &
                                                (uint8)~`$INSTANCE_NAME`_CTRL_HD_SEND);
