...
`include "cypress.v"
`ifdef  bILO_Timer_v1_10_V_ALREADY_INCLUDED
`else
`define bILO_Timer_v1_10_V_ALREADY_INCLUDED

module bILO_Timer_v1_10
(
    ...
    */
    cy_psoc3_udb_clock_enable_v1_10 #(.sync_mode(`TRUE)) ClkSync
    (
