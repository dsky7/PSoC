...
uint8 `$INSTANCE_NAME`_initVar = 0u;
    ...
    {   0u,
        `$INSTANCE_NAME`_ep1_TD_TERMOUT_EN,
        `$INSTANCE_NAME`_ep2_TD_TERMOUT_EN,
        `$INSTANCE_NAME`_ep3_TD_TERMOUT_EN,
        `$INSTANCE_NAME`_ep4_TD_TERMOUT_EN,
        `$INSTANCE_NAME`_ep5_TD_TERMOUT_EN,
        `$INSTANCE_NAME`_ep6_TD_TERMOUT_EN,
        `$INSTANCE_NAME`_ep7_TD_TERMOUT_EN,
        `$INSTANCE_NAME`_ep8_TD_TERMOUT_EN
    };
...
void `$INSTANCE_NAME`_InitComponent(uint8 device, uint8 mode) `=ReentrantKeil($INSTANCE_NAME . "_InitComponent")`
{
    ...
    */
    ...
    /* Arbiter configuration for DMA transfers */
        ...
        #endif   /*  `$INSTANCE_NAME`_EP_MM == `$INSTANCE_NAME`__EP_DMAMANUAL */
...
void `$INSTANCE_NAME`_Stop(void) `=ReentrantKeil($INSTANCE_NAME . "_Stop")`
{
    ...
    `$INSTANCE_NAME`_USBIO_CR1_REG &= (uint8)(~`$INSTANCE_NAME`_USBIO_CR1_USBPUEN);
...
uint8 `$INSTANCE_NAME`_CheckActivity(void) `=ReentrantKeil($INSTANCE_NAME . "_CheckActivity")`
{
    ...
    CY_SET_REG8(`$INSTANCE_NAME`_CR1_PTR, (r & ((uint8)(~`$INSTANCE_NAME`_CR1_BUS_ACTIVITY))));
...
uint16 `$INSTANCE_NAME`_GetEPCount(uint8 epNumber) `=ReentrantKeil($INSTANCE_NAME . "_GetEPCount")`
{
    ...
    if((epNumber > `$INSTANCE_NAME`_EP0) && (epNumber < `$INSTANCE_NAME`_MAX_EP))
    {
        ...
        result = (uint8)(CY_GET_REG8((reg8 *)(`$INSTANCE_NAME`_SIE_EP1_CNT0_IND + ri)) &
                          `$INSTANCE_NAME`_EPX_CNT0_MASK);
        result = (result << 8u) | CY_GET_REG8((reg8 *)(`$INSTANCE_NAME`_SIE_EP1_CNT1_IND + ri));
        result -= `$INSTANCE_NAME`_EPX_CNTX_CRC_COUNT;
    }
    return(result);
}
                                                                        ...
                                                                        `=ReentrantKeil($INSTANCE_NAME . "_LoadInEP")`
{
    ...
    {
        ri = ((epNumber - `$INSTANCE_NAME`_EP1) << `$INSTANCE_NAME`_EPX_CNTX_ADDR_SHIFT);
        p = (reg8 *)(`$INSTANCE_NAME`_ARB_RW1_DR_IND + ri);
        ...
        CY_SET_REG8((reg8 *)(`$INSTANCE_NAME`_SIE_EP1_CNT0_IND + ri),
                            (length >> 8u) | (`$INSTANCE_NAME`_EP[epNumber].epToggle));
        CY_SET_REG8((reg8 *)(`$INSTANCE_NAME`_SIE_EP1_CNT1_IND + ri),  length & 0xFFu);
            ...
            CY_SET_REG8((reg8 *)(`$INSTANCE_NAME`_SIE_EP1_CR0_IND + ri), `$INSTANCE_NAME`_EP[epNumber].epMode);
        #else
            ...
            if ((pData != NULL) && (length > 0u))
            {
                ...
                (void) CyDmaTdSetConfiguration(`$INSTANCE_NAME`_DmaTd[epNumber], length, CY_DMA_DISABLE_TD,
                                                                                 TD_TERMIN_EN | TD_INC_SRC_ADR);
                (void) CyDmaTdSetAddress(`$INSTANCE_NAME`_DmaTd[epNumber],  LO16((uint32)pData), LO16((uint32)p));
                /* Enable the DMA */
                ...
                * (reg8 *)(`$INSTANCE_NAME`_ARB_EP1_CFG_IND + ri) |= `$INSTANCE_NAME`_ARB_EPX_CFG_DMA_REQ;
                * (reg8 *)(`$INSTANCE_NAME`_ARB_EP1_CFG_IND + ri) &= ((uint8)(~`$INSTANCE_NAME`_ARB_EPX_CFG_DMA_REQ));
            ...
            if (pData != NULL)
            {
                ...
                */
                ...
                (void) CyDmaTdSetAddress(`$INSTANCE_NAME`_DmaNextTd[epNumber],  LO16((uint32)&clearInDataRdyStatus),
                                                                LO16((uint32)(`$INSTANCE_NAME`_ARB_EP1_CFG_IND + ri)));
            ...
            else
            {
                ...
                if(length > 0u)
                {
                    ...
                    (void) CyDmaTdSetConfiguration(
                        ...
                        `$INSTANCE_NAME`_DmaNextTd[epNumber], TD_TERMIN_EN | TD_INC_SRC_ADR );
                    (void) CyDmaTdSetAddress(`$INSTANCE_NAME`_DmaTd[epNumber],
                                             LO16((uint32)`$INSTANCE_NAME`_inDataPointer[epNumber]), LO16((uint32)p));
                    /* Clear Any potential pending DMA requests before starting the DMA channel to transfer data */
                    (void) CyDmaClearPendingDrq(`$INSTANCE_NAME`_DmaChan[epNumber]);
                    /* Enable the DMA */
                    (void) CyDmaChSetInitialTd(`$INSTANCE_NAME`_DmaChan[epNumber], `$INSTANCE_NAME`_DmaTd[epNumber]);
                    ...
                    #ifndef `$INSTANCE_NAME`_MANUAL_IN_EP_ARM
                        * (reg8 *)(`$INSTANCE_NAME`_ARB_EP1_CFG_IND + ri) |= `$INSTANCE_NAME`_ARB_EPX_CFG_IN_DATA_RDY;
                                                                        ...
                                                                        `=ReentrantKeil($INSTANCE_NAME . "_ReadOutEP")`
{
    ...
    if((epNumber > `$INSTANCE_NAME`_EP0) && (epNumber < `$INSTANCE_NAME`_MAX_EP) && (pData != NULL))
    {
        ...
        p = (reg8 *)(`$INSTANCE_NAME`_ARB_RW1_DR_IND + ri);
            ...
            (void) CyDmaTdSetAddress(`$INSTANCE_NAME`_DmaTd[epNumber],  LO16((uint32)p), LO16((uint32)pData));
            /* Enable the DMA */
            (void) CyDmaChSetInitialTd(`$INSTANCE_NAME`_DmaChan[epNumber], `$INSTANCE_NAME`_DmaTd[epNumber]);
            (void) CyDmaChEnable(`$INSTANCE_NAME`_DmaChan[epNumber], 1u);
            ...
            * (reg8 *)(`$INSTANCE_NAME`_ARB_EP1_CFG_IND + ri) &= ((uint8)(~`$INSTANCE_NAME`_ARB_EPX_CFG_DMA_REQ));
            ...
            /* Enable DMA in mode3 for transferring data */
            (void) CyDmaChDisable(`$INSTANCE_NAME`_DmaChan[epNumber]);
            (void) CyDmaTdSetConfiguration(`$INSTANCE_NAME`_DmaTd[epNumber], length, `$INSTANCE_NAME`_DmaTd[epNumber],
                                                                                TD_TERMIN_EN | TD_INC_DST_ADR);
            (void) CyDmaTdSetAddress(`$INSTANCE_NAME`_DmaTd[epNumber],  LO16((uint32)p), LO16((uint32)pData));
...
uint8 `$INSTANCE_NAME`_GetEPAckState(uint8 epNumber) `=ReentrantKeil($INSTANCE_NAME . "_GetEPAckState")`
{
    ...
    {
        ri = ((epNumber - `$INSTANCE_NAME`_EP1) << `$INSTANCE_NAME`_EPX_CNTX_ADDR_SHIFT);
        cr = CY_GET_REG8((reg8 *)(`$INSTANCE_NAME`_SIE_EP1_CR0_IND + ri)) & `$INSTANCE_NAME`_MODE_ACKD;
    }
...
void `$INSTANCE_NAME`_SetPowerStatus(uint8 powerStatus) `=ReentrantKeil($INSTANCE_NAME . "_SetPowerStatus")`
{
    ...
    *******************************************************************************/
    ...
    {
        return((0u != (CY_GET_REG8(`$INSTANCE_NAME`_VBUS_PS_PTR) & `$INSTANCE_NAME`_VBUS_MASK)) ? 1u : 0u);
    }
