...
#define `$INSTANCE_NAME`_EP_DMA_AUTO_OPT                (`$epDMAautoOptimization`u)
...
#define `$INSTANCE_NAME`_MSOS_CONF_DESCR_LENGTH         (40u)
    ...
    #endif /* `$INSTANCE_NAME`_DMA1_REMOVE == 0u */
    ...
    #endif /* `$INSTANCE_NAME`_DMA2_REMOVE == 0u */
    ...
    #endif /* `$INSTANCE_NAME`_DMA3_REMOVE == 0u */
    ...
    #endif /* `$INSTANCE_NAME`_DMA4_REMOVE == 0u */
    ...
    #endif /* `$INSTANCE_NAME`_DMA5_REMOVE == 0u */
    ...
    #endif /* `$INSTANCE_NAME`_DMA6_REMOVE == 0u */
    ...
    #endif /* `$INSTANCE_NAME`_DMA7_REMOVE == 0u */
    ...
    #endif /* `$INSTANCE_NAME`_DMA8_REMOVE == 0u */
...
#define `$INSTANCE_NAME`_ARB_EP1_CFG_IND    `$INSTANCE_NAME`_USB__ARB_EP1_CFG
...
#define `$INSTANCE_NAME`_ARB_EP1_INT_EN_IND `$INSTANCE_NAME`_USB__ARB_EP1_INT_EN
...
#define `$INSTANCE_NAME`_ARB_EP1_SR_IND     `$INSTANCE_NAME`_USB__ARB_EP1_SR
...
#define `$INSTANCE_NAME`_ARB_RW1_DR_IND     `$INSTANCE_NAME`_USB__ARB_RW1_DR
#define `$INSTANCE_NAME`_ARB_RW1_RA_PTR     ((reg8 *) `$INSTANCE_NAME`_USB__ARB_RW1_RA)
#define `$INSTANCE_NAME`_ARB_RW1_RA_IND     `$INSTANCE_NAME`_USB__ARB_RW1_RA
#define `$INSTANCE_NAME`_ARB_RW1_RA_MSB_PTR ((reg8 *) `$INSTANCE_NAME`_USB__ARB_RW1_RA_MSB)
#define `$INSTANCE_NAME`_ARB_RW1_RA_MSB_IND `$INSTANCE_NAME`_USB__ARB_RW1_RA_MSB
#define `$INSTANCE_NAME`_ARB_RW1_WA_PTR     ((reg8 *) `$INSTANCE_NAME`_USB__ARB_RW1_WA)
#define `$INSTANCE_NAME`_ARB_RW1_WA_IND     `$INSTANCE_NAME`_USB__ARB_RW1_WA
#define `$INSTANCE_NAME`_ARB_RW1_WA_MSB_PTR ((reg8 *) `$INSTANCE_NAME`_USB__ARB_RW1_WA_MSB)
#define `$INSTANCE_NAME`_ARB_RW1_WA_MSB_IND `$INSTANCE_NAME`_USB__ARB_RW1_WA_MSB
...
#define `$INSTANCE_NAME`_EP0_DR0_IND        `$INSTANCE_NAME`_USB__EP0_DR0
...
#define `$INSTANCE_NAME`_SIE_EP1_CNT0_IND   `$INSTANCE_NAME`_USB__SIE_EP1_CNT0
...
#define `$INSTANCE_NAME`_SIE_EP1_CNT1_IND   `$INSTANCE_NAME`_USB__SIE_EP1_CNT1
...
#define `$INSTANCE_NAME`_SIE_EP1_CR0_IND    `$INSTANCE_NAME`_USB__SIE_EP1_CR0
...
#define `$INSTANCE_NAME`_DP_INTSTAT_REG     (* (reg8 *) `$INSTANCE_NAME`_Dp__INTSTAT)
...
#if (`$INSTANCE_NAME`_MON_VBUS == 1u)
    #if (`$INSTANCE_NAME`_EXTERN_VBUS == 0u)
    ...
    #endif /*  `$INSTANCE_NAME`_EXTERN_VBUS == 0u */
#endif /*  `$INSTANCE_NAME`_MON_VBUS */
...
#define `$INSTANCE_NAME`_CR1_BUS_ACTIVITY           ((uint8)(0x01u << `$INSTANCE_NAME`_CR1_BUS_ACTIVITY_SHIFT))
...
#endif /*  `$INSTANCE_NAME`_EP_MM == `$INSTANCE_NAME`__EP_DMAAUTO */
#define `$INSTANCE_NAME`_ARB_INT_MASK       (uint8)((`$INSTANCE_NAME`_DMA1_REMOVE ^ 1u) | \
                                            (uint8)((`$INSTANCE_NAME`_DMA2_REMOVE ^ 1u) << 1u) | \
                                            (uint8)((`$INSTANCE_NAME`_DMA3_REMOVE ^ 1u) << 2u) | \
                                            (uint8)((`$INSTANCE_NAME`_DMA4_REMOVE ^ 1u) << 3u) | \
                                            (uint8)((`$INSTANCE_NAME`_DMA5_REMOVE ^ 1u) << 4u) | \
                                            (uint8)((`$INSTANCE_NAME`_DMA6_REMOVE ^ 1u) << 5u) | \
                                            (uint8)((`$INSTANCE_NAME`_DMA7_REMOVE ^ 1u) << 6u) | \
                                            (uint8)((`$INSTANCE_NAME`_DMA8_REMOVE ^ 1u) << 7u) )
