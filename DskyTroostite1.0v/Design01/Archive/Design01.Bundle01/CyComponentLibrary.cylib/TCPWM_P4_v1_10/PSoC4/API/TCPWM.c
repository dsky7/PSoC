...
void `$INSTANCE_NAME`_Init(void)
{
    ...
    #if (`$INSTANCE_NAME`__QUAD == `$INSTANCE_NAME`_CONFIG)
        `$INSTANCE_NAME`_TRIG_CONTROL1_REG  =
    ...
    /* Set other values from customizer */
        ...
        #if (`$INSTANCE_NAME`__COUNT_DOWN == `$INSTANCE_NAME`_TC_COUNTER_MODE)
            `$INSTANCE_NAME`_WriteCounter(`$INSTANCE_NAME`_TC_PERIOD_VALUE );
        #endif  /* (`$INSTANCE_NAME`__COUNT_DOWN == `$INSTANCE_NAME`_TC_COUNTER_MODE) */
...
void `$INSTANCE_NAME`_WriteCompare(uint32 compare)
{
        ...
        uint32 currentMode;
    #endif /* (`$INSTANCE_NAME`_CY_TCPWM_V2) */

    #if (`$INSTANCE_NAME`_CY_TCPWM_V2)
        currentMode = ((`$INSTANCE_NAME`_CONTROL_REG & `$INSTANCE_NAME`_UPDOWN_MASK) >> `$INSTANCE_NAME`_UPDOWN_SHIFT);

        if (`$INSTANCE_NAME`__COUNT_DOWN == currentMode)
        {
            `$INSTANCE_NAME`_COMP_CAP_REG = ((compare + 1u) & `$INSTANCE_NAME`_16BIT_MASK);
        }
        else if (`$INSTANCE_NAME`__COUNT_UP == currentMode)
        {
            `$INSTANCE_NAME`_COMP_CAP_REG = ((compare - 1u) & `$INSTANCE_NAME`_16BIT_MASK);
        }
        else
...
uint32 `$INSTANCE_NAME`_ReadCompare(void)
{
        ...
        if (`$INSTANCE_NAME`__COUNT_DOWN == currentMode)
        {
            regVal = ((`$INSTANCE_NAME`_COMP_CAP_REG - 1u) & `$INSTANCE_NAME`_16BIT_MASK);
        }
        else if (`$INSTANCE_NAME`__COUNT_UP == currentMode)
        {
            regVal = ((`$INSTANCE_NAME`_COMP_CAP_REG + 1u) & `$INSTANCE_NAME`_16BIT_MASK);
        ...
        {
            regVal = (`$INSTANCE_NAME`_COMP_CAP_REG & `$INSTANCE_NAME`_16BIT_MASK);
        }
        return (regVal);
    #else
...
void `$INSTANCE_NAME`_WriteCompareBuf(uint32 compareBuf)
{
        ...
        if (`$INSTANCE_NAME`__COUNT_DOWN == currentMode)
        {
            `$INSTANCE_NAME`_COMP_CAP_BUF_REG = ((compareBuf + 1u) & `$INSTANCE_NAME`_16BIT_MASK);
        }
        else if (`$INSTANCE_NAME`__COUNT_UP == currentMode)
        {
            `$INSTANCE_NAME`_COMP_CAP_BUF_REG = ((compareBuf - 1u) & `$INSTANCE_NAME`_16BIT_MASK);
...
uint32 `$INSTANCE_NAME`_ReadCompareBuf(void)
{
        ...
        if (`$INSTANCE_NAME`__COUNT_DOWN == currentMode)
        {
            regVal = ((`$INSTANCE_NAME`_COMP_CAP_BUF_REG - 1u) & `$INSTANCE_NAME`_16BIT_MASK);
        }
        else if (`$INSTANCE_NAME`__COUNT_UP == currentMode)
        {
            regVal = ((`$INSTANCE_NAME`_COMP_CAP_BUF_REG + 1u) & `$INSTANCE_NAME`_16BIT_MASK);
        ...
        {
            regVal = (`$INSTANCE_NAME`_COMP_CAP_BUF_REG & `$INSTANCE_NAME`_16BIT_MASK);
        }
        return (regVal);
    #else
