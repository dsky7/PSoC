...
volatile int16 ADC_SAR_Seq_SAR_countsPerVolt;     /* Obsolete Gain compensation */
volatile int32 ADC_SAR_Seq_SAR_countsPer10Volt;   /* Gain compensation */
...
*  ADC_SAR_Seq_SAR_Start() sets the initVar variable, calls the
*  ADC_SAR_Seq_SAR_Init() function, and then calls the
*  ADC_SAR_Seq_SAR_Enable() function.
*
* Parameters:
*  None.
*
...
void ADC_SAR_Seq_SAR_Enable(void)
{
    ...
    ADC_SAR_Seq_SAR_SAR_TR0_REG = ADC_SAR_Seq_SAR_SAR_CAP_TRIM_2;
...
void ADC_SAR_Seq_SAR_SetResolution(uint8 resolution)
{
    ...
    *  ADC_SAR_Seq_SAR_StartConvert(). This function is not available when the
...
*   ADC_SAR_Seq_SAR_RETURN_STATUS: Immediately returns the status. If the
...
*   ADC_SAR_Seq_SAR_WAIT_FOR_RESULT: Does not return a result until the ADC
...
*
* Global Variables:
*  ADC_SAR_Seq_SAR_shift - used to convert the ADC counts to the 2s
*  compliment form.
*
* Side Effects:
...
*
* Summary:
*  Sets the ADC offset, which is used by ADC_SAR_Seq_SAR_CountsTo_Volts(),
*  ADC_SAR_Seq_SAR_CountsTo_mVolts(), and ADC_SAR_Seq_SAR_CountsTo_uVolts()
...
*  ADC_SAR_Seq_SAR_countsPer10Volt variable initialized. This variable is used
...
static void ADC_SAR_Seq_SAR_CalcGain( uint8 resolution )
{
    ...
    {
        case (uint8)ADC_SAR_Seq_SAR__BITS_12:
            counts = (int32)ADC_SAR_Seq_SAR_SAR_WRK_MAX_12BIT;
            #if(!((ADC_SAR_Seq_SAR_DEFAULT_RANGE == ADC_SAR_Seq_SAR__VSS_TO_VREF) || \
                 (ADC_SAR_Seq_SAR_DEFAULT_RANGE == ADC_SAR_Seq_SAR__VSSA_TO_VDDA) || \
                 (ADC_SAR_Seq_SAR_DEFAULT_RANGE == ADC_SAR_Seq_SAR__VSSA_TO_VDAC)) )
            ...
            break;
        case (uint8)ADC_SAR_Seq_SAR__BITS_10:
            counts = (int32)ADC_SAR_Seq_SAR_SAR_WRK_MAX_10BIT;
            #if(!((ADC_SAR_Seq_SAR_DEFAULT_RANGE == ADC_SAR_Seq_SAR__VSS_TO_VREF) || \
                 (ADC_SAR_Seq_SAR_DEFAULT_RANGE == ADC_SAR_Seq_SAR__VSSA_TO_VDDA) || \
                 (ADC_SAR_Seq_SAR_DEFAULT_RANGE == ADC_SAR_Seq_SAR__VSSA_TO_VDAC)) )
            ...
            break;
        case (uint8)ADC_SAR_Seq_SAR__BITS_8:
            counts = (int32)ADC_SAR_Seq_SAR_SAR_WRK_MAX_8BIT;
            #if(!((ADC_SAR_Seq_SAR_DEFAULT_RANGE == ADC_SAR_Seq_SAR__VSS_TO_VREF) || \
                 (ADC_SAR_Seq_SAR_DEFAULT_RANGE == ADC_SAR_Seq_SAR__VSSA_TO_VDDA) || \
                 (ADC_SAR_Seq_SAR_DEFAULT_RANGE == ADC_SAR_Seq_SAR__VSSA_TO_VDAC)) )
    ...
    ADC_SAR_Seq_SAR_countsPerVolt = 0; /* Clear obsolete variable */
    /* Calculate gain in counts per 10 volts with rounding */
    ADC_SAR_Seq_SAR_countsPer10Volt = (((counts * ADC_SAR_Seq_SAR_10MV_COUNTS) +
                        ADC_SAR_Seq_SAR_DEFAULT_REF_VOLTAGE_MV) / (ADC_SAR_Seq_SAR_DEFAULT_REF_VOLTAGE_MV * 2));
...
*
* Global Variables:
*  ADC_SAR_Seq_SAR_countsPer10Volt variable modified. This variable is used
*  for gain calibration purpose.
*
*******************************************************************************/
void ADC_SAR_Seq_SAR_SetGain(int16 adcGain)
{
    ADC_SAR_Seq_SAR_countsPer10Volt = (int32)adcGain * 10;
}


/*******************************************************************************
* Function Name: ADC_SAR_Seq_SAR_SetGainPer10Volt
********************************************************************************
*
* Summary:
...
{
    ADC_SAR_Seq_SAR_countsPer10Volt = adcGain;
}
...
*  ADC_SAR_Seq_SAR_countsPer10Volt variable used.
*
*******************************************************************************/
int16 ADC_SAR_Seq_SAR_CountsTo_mVolts(int16 adcCounts)
{
    ...
    if(ADC_SAR_Seq_SAR_countsPerVolt != 0)
    {   /* Support obsolete method */
        countsPer10Volt = (int32)ADC_SAR_Seq_SAR_countsPerVolt * 10;
    }
    else
    {
        countsPer10Volt = ADC_SAR_Seq_SAR_countsPer10Volt;
    }

    /* Subtract ADC offset */
    adcCounts -= ADC_SAR_Seq_SAR_offset;
    /* Convert to millivolts with rounding */
    mVolts = (int16)( (( (int32)adcCounts * ADC_SAR_Seq_SAR_10MV_COUNTS ) + ( (adcCounts > 0) ?
...
* Global Variables:
*  ADC_SAR_Seq_SAR_offset variable used.
*  ADC_SAR_Seq_SAR_countsPer10Volt used to convert ADC counts to uVolts.
*
*******************************************************************************/
int32 ADC_SAR_Seq_SAR_CountsTo_uVolts(int16 adcCounts)
{
    ...
    */
    uVolts = (( (int64)adcCounts * ADC_SAR_Seq_SAR_10UV_COUNTS ) / countsPer10Volt);
...
* Global Variables:
*  ADC_SAR_Seq_SAR_offset variable used.
*  ADC_SAR_Seq_SAR_countsPer10Volt used to convert ADC counts to Volts.
*
*******************************************************************************/
float32 ADC_SAR_Seq_SAR_CountsTo_Volts(int16 adcCounts)
{
    ...
    volts = ((float32)adcCounts * ADC_SAR_Seq_SAR_10V_COUNTS) / (float32)countsPer10Volt;
