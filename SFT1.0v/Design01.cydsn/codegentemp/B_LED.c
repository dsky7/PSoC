...
{
    uint8 staticBits = (B_LED_DR & (uint8)(~B_LED_MASK));
    B_LED_DR = staticBits | ((uint8)(value << B_LED_SHIFT) & B_LED_MASK);
}
...
{
	CyPins_SetPinDriveMode(B_LED_0, mode);
}
...
{
    return (B_LED_PS & B_LED_MASK) >> B_LED_SHIFT;
}
...
{
    return (B_LED_DR & B_LED_MASK) >> B_LED_SHIFT;
}
...
/* If Interrupts Are Enabled for this Pins component */ 
    ...
    *******************************************************************************/
    ...
    {
        return (B_LED_INTSTAT & B_LED_MASK) >> B_LED_SHIFT;
    }
